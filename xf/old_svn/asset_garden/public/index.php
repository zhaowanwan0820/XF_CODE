...
defined ( 'ROOT_PATH' ) or define ( 'ROOT_PATH', '/home/work/itouzi.com/itouzi.com/' );
//debug开关
...
header("Access-Control-Allow-Headers: X-HH-AUTHORIZATION,AUTHORIZATION,Content-Type,Accept,Origin,User-Agent,DNT,Cache-Control,X-Mx-ReqToken,Keep-Alive,X-Requested-With,If-Modified-Since");
