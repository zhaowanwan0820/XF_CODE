...
/**
 * This is the model class for table "firstp2p_deal_agency".
 *
 * The followings are the available columns in table 'firstp2p_deal_agency':
 * @property integer $id
 ...
 */
class PHDealAgency extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PHDealAgency the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('header, name, brief, company_brief, history, content, is_effect, sort, short_name, address, realname, postcode, fax, email, review, premium, caution_money, agreement, mechanism, business_place_state, risk_control, agency_brief, man_product, team_brief, future_expectation', 'required'),
			array('type, user_id, agency_user_id, is_effect, create_time, update_time, sort, is_icp, site_id, is_credit_display', 'numerical', 'integerOnly'=>true),
