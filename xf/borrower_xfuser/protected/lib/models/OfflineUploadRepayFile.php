...
/**
 * This is the model class for table "offline_upload_repay_file".
 *
 * The followings are the available columns in table 'offline_upload_repay_file':
 * @property string $id
 ...
 */
class OfflineUploadRepayFile extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return OfflineUploadRepayFile the static model class
	 */
	...
	{
		return 'offline_upload_repay_file';
	}
