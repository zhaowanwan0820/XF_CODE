    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/XFDebt/ZDXDealLoadBYUser',
          method   : 'post',
          where    : {deal_type : 4},
          response :
          {
        ...
        form.on('submit(sreach_a)', function(obj){
          ...
          if (obj.field.type == 0) {
            ...
            xadmin.open('通过上传用户ID查询','/user/XFDebt/addDealLoadBYUserCondition?deal_type=4&type=1');
          }
          return false;
        });
      ...
      function DealLoadBYUser2Excel()
      {
        ...
        if (user_id == '' && user_mobile == '' && user_idno == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/ZDXDealLoadBYUser2Excel?deal_type=4&user_id="+user_id+"&user_mobile="+user_mobile+"&user_idno="+user_idno , "_blank");
          });
        }
      }
      ...
      function DealLoadBYUser2ExcelA()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/ZDXDealLoadBYUser2Excel?deal_type=4&condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
