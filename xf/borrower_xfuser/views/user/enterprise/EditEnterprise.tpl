...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/user/Enterprise/EditEnterprise" enctype="multipart/form-data" id="my_form">
                    <input type="hidden" name="id" id="ent_id" value="<{$res['id']}>">
                    <input type="hidden" name="update_time" value="<{$res['update_time']}>">
                    <input type="hidden" name="enterprise_id" id="enterprise_id" value="<{$res['enterprise_id']}>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="company_name" id="company_name" value="<{$res['company_name']}>" autocomplete="off" class="layui-input" onchange="check_company_name(this.value)"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="credentials_no" id="credentials_no" value="<{$res['credentials_no']}>" autocomplete="off" class="layui-input" onchange="check_credentials_no(this.value)"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="legalbody_name" id="legalbody_name" value="<{$res['legalbody_name']}>" autocomplete="off" class="layui-input"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="legalbody_credentials_no" id="legalbody_credentials_no" value="<{$res['legalbody_credentials_no']}>" autocomplete="off" class="layui-input"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="legalbody_mobile" id="legalbody_mobile" value="<{$res['legalbody_mobile']}>" autocomplete="off" class="layui-input" onchange="check_legalbody_mobile(this.value)"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="registration_address" id="registration_address" value="<{$res['registration_address']}>" autocomplete="off" class="layui-input" style="width: 380px"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="contract_address" id="contract_address" value="<{$res['contract_address']}>" autocomplete="off" class="layui-input" style="width: 380px"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <span id="credit_code_file_name"><{$res['credit_code_file_name']}></span>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <span id="power_attorney_file_name"><{$res['power_attorney_file_name']}></span>
        ...
        function check_company_name(value)
        {
          ...
          $.ajax({
            ...
            type:'post',
            dataType:'json',
            data:{'company_name':value,'id':ent_id},
        ...
        function check_credentials_no(value)
        {
          ...
          $.ajax({
            ...
            type:'post',
            dataType:'json',
            data:{'credentials_no':value,'id':ent_id},
            success:function(res){
              if (res['code'] == 1) {
        ...
        function check_legalbody_mobile(value)
        {
          ...
          $.ajax({
            ...
            type:'post',
            dataType:'json',
            data:{'legalbody_mobile':value,'id':ent_id},
            success:function(res){
              if (res['code'] > 1) {
                layer.msg(res['info'] , {icon:2 , time:5000});
              }
