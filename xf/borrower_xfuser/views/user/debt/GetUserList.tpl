                                ...
                                <div class="layui-colla-content layui-show">
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                          <label class="layui-form-label">服务人邀请码</label>
                                          <div class="layui-input-inline">
                                            <input type="text" name="short_alias" placeholder="请输入服务人邀请码" autocomplete="off" class="layui-input" value="">
                                          </div>
                                        </div>

                                        <div class="layui-inline">
                                          <label class="layui-form-label">帐户类型</label>
                                          <div class="layui-input-inline">
      ...
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        form.on('submit(sreach)', function(obj){
          table.reload('list', {
            ...
            where    :
            {
              ...
              short_alias     : obj.field.short_alias.trim(),
        ...
        */  
        form.on('submit(user_condition_upload)', function(obj){
          ...
          if (obj.field.type == 1) {
            xadmin.open('通过上传用户ID查询','/user/Debt/AddUserConditionUpload?type=1');
          }
          return false;
        });
        ...
        */
        function user_list_excel()
        {
          ...
          var idno          = $("input[name='idno']").val().trim();
          var bankcard      = $("input[name='bankcard']").val().trim();
          var short_alias   = $("input[name='short_alias']").val().trim();
          ...
          if ((id == undefined || id == '') && 
              ...
              (short_alias == undefined || short_alias == '')) {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Debt/UserListExcel?id="+id+"&member_id="+member_id
              +"&user_name="+user_name+"&real_name="+real_name
              +"&mobile="+mobile+"&idno="+idno
              +"&bankcard="+bankcard+"&short_alias="+short_alias
        ...
        */
        function batch_user_list_excel()
        {
          ...
          if (condition_id == '') {
            ...
            function(index) {
              layer.close(index);
              window.open("/user/Debt/UserListExcel?condition_id="+condition_id+"&search_type=2" , "_blank");
              reset_condition();
            });
          }
        }
