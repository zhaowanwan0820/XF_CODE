              ...
              <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="type" value="1" title="立即发布" lay-filter="type">
                        <input type="radio" name="type" value="2" title="定时发布" lay-filter="type" checked>
                    </div>
                </div>
                ...
                <div class="layui-form-item" id="time_div">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="start_time" name="start_time" readonly autocomplete="off" class="layui-input" value="<{$res['start_time']}>"></div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="user_1" value="1" title="全量在途用户" lay-filter="user_1" <{if $res['user_scope'] == 1 }>checked<{/if}>>
                        <input type="radio" name="user_1" value="2" title="指定在途用户" lay-filter="user_1" <{if $res['user_scope'] == 2 }>checked<{/if}>>
                    </div>
                ...
                <div id="zhiding" <{if $res['user_scope'] == 1 }>style="display: none;"<{/if}>>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="radio" name="user_2" value="1" title="输入项目ID" lay-filter="user_2" <{if $res['type'] == 1 }>checked<{/if}>>
                          <input type="radio" name="user_2" value="2" title="输入借款编号" lay-filter="user_2" <{if $res['type'] == 2 }>checked<{/if}>>
                          <input type="radio" name="user_2" value="3" title="输入用户ID" lay-filter="user_2" <{if $res['type'] == 3 }>checked<{/if}>>
                          <input type="radio" name="user_2" value="4" title="上传用户ID" lay-filter="user_2" <{if $res['type'] == 4 }>checked<{/if}>>
                      </div>
                  </div>
                  ...
                  <div class="layui-form-item" id="platform_div" <{if $res['type'] gt 2 }>style="display: none;"<{/if}>>
                      ...
                      <div class="layui-input-inline">
                          <input type="radio" name="platform" value="1" title="尊享" lay-filter="platform" <{if $res['platform'] == 1 }>checked<{/if}>>
                          <input type="radio" name="platform" value="2" title="普惠" lay-filter="platform" <{if $res['platform'] == 2 }>checked<{/if}>>
                      </div>
                  </div>
                  ...
                  <div class="layui-form-item layui-form-text" id="project_id_div" <{if $res['type'] != 1 }>style="display: none;"<{/if}>>
                      ...
                      <div class="layui-input-inline">
                          <textarea placeholder="请输入项目ID（多个以英文逗号,分隔）" id="project_id" name="project_id" class="layui-textarea" style="width: 400px;"><{$res['project_id']}></textarea>
                      </div>
                  </div>
                  ...
                  <div class="layui-form-item layui-form-text" id="deal_id_div" <{if $res['type'] != 2 }>style="display: none;"<{/if}>>
                      ...
                      <div class="layui-input-inline">
                          <textarea placeholder="请输入借款编号（多个以英文逗号,分隔）" id="deal_id" name="deal_id" class="layui-textarea" style="width: 400px;"><{$res['deal_id']}></textarea>
                      </div>
                  </div>
                  ...
                  <div class="layui-form-item layui-form-text" id="user_id_div" <{if $res['type'] != 3 }>style="display: none;"<{/if}>>
                      ...
                      <div class="layui-input-inline">
                          <textarea placeholder="请输入用户ID（多个以英文逗号,分隔）" id="user_id" name="user_id" class="layui-textarea" style="width: 400px;"><{$res['user_id']}></textarea>
                      </div>
                  </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="title" name="title" lay-verify="required" autocomplete="off" class="layui-input" style="width: 300px;" value="<{$res['title']}>" onkeyup="check_title()" onchange="check_title()"></div>
                ...
                <div class="layui-form-item">
                    <label for="abstract" class="layui-form-label">
                        摘要</label>
                    <div class="layui-input-inline">
                        <input type="text" id="abstract" name="abstract" autocomplete="off" class="layui-input" style="width: 400px;" value="<{$res['abstract']}>" onkeyup="check_abstract()" onchange="check_abstract()"></div>
        ...
        layui.use(['layedit' , 'layer' , 'form' , 'laydate' , 'upload' , 'element'] , function(){
          ...
          form.on('submit(add)' , function(data)
          {
            ...
            if (data.field.start_time == '' && data.field.type == 2) {
              layer.alert('请选择发布时间');
            } else if (data.field.platform == '' && (data.field.user_2 == 1 || data.field.user_2 == 2) && data.field.user_1 == 2) {
              layer.alert('请选择指定平台');
