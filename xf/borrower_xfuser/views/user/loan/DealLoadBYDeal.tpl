                                      ...
                                      <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                          <select name="type" lay-search="">
                                            ...
                                            <option value="6">上传交易所备案编号</option>
                                          </select>
                                        </div>
                                      </div>
...
<script>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          elem           : '#list',
          toolbar        : '<div><i class="iconfont" style="color:orange;">&#xe6b6;</i> 投资人人数、受让人人数、投资人持有金额、受让人持有金额非实时数据，每一小时更新一次。</div>',
        ...
        form.on('submit(sreach_a)', function(obj){
          ...
          if (obj.field.type == 0) {
            ...
            xadmin.open('通过上传融资方名称查询','/user/Loan/addDealLoadBYDealCondition?type=1');
            ...
            xadmin.open('通过上传交易所备案编号查询','/user/Loan/addDealLoadBYDealCondition?type=6');
          }
          return false;
        });
      ...
      function DealLoadBYDeal2ExcelA()
      {
        ...
        if (deal_id == '' && deal_name == '' && project_id == '' && project_name == '' && jys_record_number == '' && user_name == '' && advisory_name == '' && agency_name == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Loan/DealLoadBYDeal2Excel?platform="+platform+"&deal_id="+deal_id+"&deal_name="+deal_name+"&project_id="+project_id+"&project_name="+project_name+"&jys_record_number="+jys_record_number+"&user_name="+user_name+"&advisory_name="+advisory_name+"&agency_name="+agency_name , "_blank");
          });
        }
      }
