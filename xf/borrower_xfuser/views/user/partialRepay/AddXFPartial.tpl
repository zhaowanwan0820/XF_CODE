...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/user/PartialRepay/AddXFPartial" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux"><span class="x-red">*</span>请上传 xls 文件（数据量不可超过5000行） <a href="/user/PartialRepay/AddXFPartial?download=1" style="color: blue;">下载模板</a></div>
                    </div>
                    <!--春节后注释出清部分功能-->
