...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="/user/PartialRepay/StartLoanRepay" method="post" enctype="multipart/form-data" id="my_form">
                    <input type="hidden" name="id" value="<{$info['id']}>">
                    <input type="hidden" name="deal_id" value="<{$info['deal_id']}>">
                    <input type="hidden" name="repay_type" value="<{$info['repay_type']}>">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                        <input type="radio" value="1" title="本金" <{if $info['repay_type'] eq '1'}>checked<{/if}> readonly>
                        <input type="radio" value="2" title="利息" <{if $info['repay_type'] eq '2'}>checked<{/if}> readonly>
                      </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="loan_repay_time" class="layui-form-label">
                            <span class="x-red">*</span>正常还款日期</label>
                        <div class="layui-input-inline">
                            <input type="text" name="loan_repay_time" id="loan_repay_time" autocomplete="off" class="layui-input" readonly style="background:#c2c2c2;" value="<{$info['loan_repay_time']}>"></div>
                    </div>

                    <div class="layui-form-item">
                        <label for="real_amount" class="layui-form-label">
                            <span class="x-red">*</span>还款金额</label>
                        <div class="layui-input-inline">
                            <input type="text" name="real_amount" id="real_amount" autocomplete="off" class="layui-input" readonly style="background:#c2c2c2;" value="<{$info['real_amount']}>"></div>
                    </div>
