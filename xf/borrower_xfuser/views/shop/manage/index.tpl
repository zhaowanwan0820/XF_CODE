                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="name" id="name" placeholder="请输入商城名称" autocomplete="off" id="username" class="layui-input" value="<{$_GET['username']}>">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <div class="layui-input-block">
                                                ...
                                                <button type="button" class="layui-btn layui-btn-warm" onclick="xadmin.open('添加商城','/shop/Manage/shopAdd',600,400)"><i class="layui-icon"></i>添加</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
<script>
    layui.use(['laydate', 'table', 'layer', 'form'], function () {
        ...
        var join = [
            ...
            {field: 'secret', title: '接口秘钥', width: 200},
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'edit') {
                xadmin.open('编辑', '/shop/Manage/shopEdit?id=' + data.id );
            } else if (layEvent === 'user_allow') {
                xadmin.open('用户白名单', '/shop/Manage/userAllowDetail?appid=' + data.id );
            }
            else if (layEvent === 'deal_allow') {
                xadmin.open('项目白名单', '/shop/Manage/dealAllowDetail?appid=' + data.id );
            }
        });
...
<script type="text/html" id="operate">
    ...
    {{# } }}
    <button class="layui-btn" title="用户白名单" lay-event="user_allow">用户白名单</button>
