            ...
            <div class="layui-card">
                ...
                <div class="layui-tab layui-tab-brief" lay-filter="table-all">
                    <ul class="layui-tab-title">
                        <li data-status="1" id='modify_log' style="font-size: 14px;" onclick="modifyLogShow()" class="layui-this" >原还款计划</li>
                        <li data-status="0" id='repay_log' style="font-size: 14px;" onclick="repayLogShow()">新还款计划</li>

                    </ul>
                </div>
                <div class="layui-card-body ">
                    <table class="layui-table layui-form" id="repayLogTable" style="display: none;">
                        <thead>
                        <tr>
                            <th>期数</th>
                            <th>应还金额</th>
                    ...
                    <table class="layui-table layui-form hidden" id="modifyLogTable" >
                        <thead>
                            <tr>
                                <th>期数</th>
                                <th>原待还本金</th>
