...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/debtMarket/DebtBuyer/EditAssignee" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline" >
                          <select id="area_id" name="area_id" lay-verify="required">
                              ...
                              <option value="<{$val['id']}>" <{if $res['area_id'] eq $val['id'] }> selected <{/if}> ><{$val['name']}></option>
                              <{/foreach}>
                          </select>
                      </div>
                    </div>
