<template>
  <div class="item" @click="goLend()">
    <div class="top">
      ...
      <div class="state state-ed" v-if="listValue.status==0 || listValue.status==2">已结清</div>
            <div class="state state-wait" v-if="listValue.status==3">待确认</div>
    ...
    <div v-if="type == 5">
      ...
      <div class="group" v-if="listValue.max_rate > listValue.rate ">
        <div class="label">利率区间</div>
        <div class="number">{{listValue.rate | formatMoney}}~{{listValue.max_rate | formatMoney}}%</div>
      </div>
      ...
      <div class="group" v-show="listValue.status==1 ">
    ...
    <div v-else>
      <div class="group" v-show="type == 1 && listValue.jys_record_number !='' ">
        <div class="label">交易所产品名称</div>
        <div class="number">{{listValue.jys_record_number }}</div>
      </div>
      <div class="group">
