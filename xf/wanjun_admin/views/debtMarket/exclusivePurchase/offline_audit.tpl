        ...
        <form class="layui-form" >
            ...
            <div class="layui-form-item" style="font-size: 14px;">
                ...
                <{if !empty($purchaseInfo['credentials_url'])}>
                    <div class="layui-form-mid ">
                        <a href="<{$purchaseInfo['credentials_url']}>" target="view_window" style="color:blue">点击查看></a>
                    </div>
                <{/if}>
            ...
            <{if $purchaseInfo['status'] == 1 && ($purchaseInfo['pay_status'] == 0 || $purchaseInfo['pay_status'] == 3) }>
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" style="font-size: 18px;" >上传付款凭证</label>
                    ...
                    <div class="layui-form-mid " style="font-size: 15px; color: red;">* 请上传jpg、png格式图片 </div>
                ...
                <button  class="layui-btn cbtn" type="button"  lay-filter="add" lay-submit="">
                    审核通过并线下付款
                </button>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate','table','upload'], function () {
        ...
        form.on('submit(add)', function (data) {
            ...
            $.ajax({
                url: '/debtMarket/ExclusivePurchase/offlineAudit',
                data:{"id":id,'image_url':form.logo_path},
                type: "POST",
                dataType:'json',
