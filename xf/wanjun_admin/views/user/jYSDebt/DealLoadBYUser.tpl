    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/JYSDebt/DealLoadBYUser',
          method   : 'post',
          where    : {deal_type : 5},
          response :
          {
        ...
        form.on('submit(sreach_a)', function(obj){
          ...
          if (obj.field.type == 0) {
            ...
            xadmin.open('通过上传用户ID查询','/user/JYSDebt/addDealLoadBYUserCondition?deal_type=5&type=1');
          }
          return false;
        });
      ...
      function DealLoadBYUser2Excel()
      {
        ...
        if (user_id == '' && user_mobile == '' && user_idno == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/JYSDebt/DealLoadBYUser2Excel?deal_type=5&user_id="+user_id+"&user_mobile="+user_mobile+"&user_idno="+user_idno , "_blank");
          });
        }
      }
      ...
      function DealLoadBYUser2ExcelA()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/DealLoadBYUser2Excel?deal_type=5&condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
