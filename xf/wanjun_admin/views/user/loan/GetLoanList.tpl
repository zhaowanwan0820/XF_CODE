                            ...
                            <div class="layui-colla-content layui-show">
                                <form class="layui-form" action="">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">先锋投资记录ID</label>
                                            <div class="layui-input-inline">
                                                <input type="text" name="xf_deal_load_id" id="xf_deal_load_id" placeholder="请输入先锋投资记录ID" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">借款人归属地</label>
                                            <div class="layui-input-inline">
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">担保机构名称</label>
                                            <div class="layui-input-inline">
                                                <input type="text" name="agency_name" id="agency_name" placeholder="请输入担保机构名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="user_id" id="user_id" placeholder="请输入出借人ID" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="real_name" id="real_name" placeholder="请输入出借人名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
