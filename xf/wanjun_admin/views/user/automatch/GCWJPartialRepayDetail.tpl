...
<div class="x-nav">
            <span class="layui-breadcrumb">
                <a href="">工场微金还款管理</a>
                <a href="">工场微金匹配债权还本列表</a>
                <a><cite>工场微金匹配债权还本详情</cite></a>
            </span>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/Automatch/GCWJPartialRepayDetail',
          method   : 'post',
          where    : {id:<{$_GET['id']}>},
          response :
          {
      ...
      function daochu()
      {
        ...
        function(index) {
          layer.close(index);
          window.open("/user/Automatch/GCWJPartialRepayExcel?id=<{$_GET['id']}>&name="+name+"&deal_loan_id="+deal_loan_id+"&user_id="+user_id+"&status="+status+"&repay_status="+repay_status , "_blank");
        });
      }
