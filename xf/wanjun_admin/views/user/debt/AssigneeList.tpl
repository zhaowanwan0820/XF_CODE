                                ...
                                <div class="layui-colla-content layui-show">
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                          <label class="layui-form-label">受让方类型</label>
                                          <div class="layui-input-inline">
                                            <select name="buyer_type" id="buyer_type" lay-search="">
                                              <option value="">全部</option>
                                              <option value="1">通用受让方</option>
                                              <option value="2">指定借款ID受让方</option>
                                            </select>
                                          </div>
                                        </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.on('toolbar(list)' , function(obj){
          ...
          switch(obj.event){
            case 'add':
              xadmin.open('添加受让方' , '/user/Debt/AddAssignee');
              break;
          };
        });
        ...
        table.on('tool(list)' , function(obj){
          ...
          switch(layEvent){
            case 'edit':
              xadmin.open('编辑受让方' , '/user/Debt/EditAssignee?id='+data.id);
              break;
            case 'info':
              xadmin.open('指定借款ID详情' , '/user/Debt/AssigneeDeal?user_id='+data.user_id);
              break;
            case 'verify':
              layer.confirm('确认要审核通过此受让方吗？' , function(index) {
                $.ajax({
                  url:'/user/Debt/VerifyAssignee',
                  type:'post',
                  dataType:'json',
                  data:{id:data.id},
