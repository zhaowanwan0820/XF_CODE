        ...
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">本人邀请码</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['user_code']}>" style="width: 300px" disabled>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">所在组别名称</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['name']}>" style="width: 300px" disabled>
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">服务人ID</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['refer_user_id']}>" style="width: 300px" disabled>
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">服务人姓名</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['refer_real_name']}>" style="width: 300px" disabled>
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">服务人邀请码</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['short_alias']}>" style="width: 300px" disabled>
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label for="username" class="layui-form-label">服务人所在组别名称</label>
                        <div class="layui-input-inline">
                          <input type="text" autocomplete="off" class="layui-input" value="<{$info['invite_user_group_name']}>" style="width: 300px" disabled>
                        </div>
                    </div>
