              ...
              <form class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">
                        旧手机号</label>
                    <div class="layui-input-inline">
                        <input type="text" autocomplete="off" class="layui-input" readonly value="<{$res['old_mobile']}>">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux img_list">
                        <img src="<{$res['id_pic_front']}>" width="400px">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux img_list">
                        <img src="<{$res['id_pic_back']}>" width="400px">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux img_list">
                        <img src="<{$res['user_pic_front']}>" width="400px">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux img_list">
                        <img src="<{$res['user_pic_back']}>" width="400px">
                    </div>
                </div>
                <{/if}>
              </form>
