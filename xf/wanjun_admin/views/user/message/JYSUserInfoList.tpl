...
<html class="x-admin-sm">
                                ...
                                <div class="layui-colla-content layui-show">
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            <label for="new_mobile" class="layui-form-label">手机号</label>
                                            <div class="layui-input-inline">
                                                <input type="text" name="new_mobile" id="new_mobile" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/Message/JYSUserInfoList',
          method   : 'post',
          response :
          {
            statusName : 'code',
        ...
        table.on('tool(list)' , function(obj){
          ...
          if (layEvent === 'info') {
            xadmin.open('申请详情' , '/user/Message/JYSUserInfo?id='+data.id);
          } else if (layEvent === 'edit') {
            xadmin.open('审核申请' , '/user/Message/auditJYSUserInfo?id='+data.id);
          }
        });
    ...
    <script type="text/html" id="operate">
      ...
      {{# } }}
      {{# if(d.audit_status == 1 && d.status == 1){ }}
