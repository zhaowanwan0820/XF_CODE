                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <select name="platform" id="platform" lay-search="">
                                              ...
                                              <option value="2">普惠(不含智多新)</option>
    ...
    <script>
          ...
          cols:[[
            ...
            },
            {
              ...
              width : 180
                  ...
                  field : 'frozen_distinct_user_total',
                  title : '去重后总人数(排除冻结)',
                  width : 180
              },
            {
              ...
              width : 180
                  ...
                  field : 'frozen_capital_total_tips',
                  title : '在途本金总金额(排除冻结)',
                  width : 180
              },
            {
              ...
              {
                  field : 'frozen_interest_total_tips',
                  title : '在途利息总金额(排除冻结)',
                  width : 180
              },
            {
      ...
      function P2PStatistics2Excel()
      {
        ...
        if (start == '' && end == '' && platform == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/P2PStatistics2Excel?start="+start+"&end="+end+"&platform="+platform , "_blank");
          });
        }
      }
    </script>
