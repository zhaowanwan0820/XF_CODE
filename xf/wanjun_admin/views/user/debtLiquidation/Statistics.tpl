...
<html class="x-admin-sm">
        ...
        <body>
            ...
            <div class="layui-fluid">
                ...
                <div class="layui-row layui-col-space10">
                  ...
                  <div class="layui-col-xs6 layui-col-md12">
                    <div class="layui-card">
                      <div class="layui-card-header">礼包区间统计</div>
                      <div class="layui-card-body" id='gift' style="height: 1200px;" ></div>
                    </div>
                  </div>
 ...
 <script type="text/javascript">
    ...
    layui.use(['form', 'layer', 'laydate','table','laypage'], function () {
        ...
        $.ajax({
            url: '/user/DebtLiquidation/GetZongLanData',
            data: {},
            type: "GET",
                ...
                // 失联人数分类统计
                 ...
                 var option = {
                    title: {
                        ...
                        text: res.data.data2.total==null ?'暂无数据':'',
                    ...
                    legend: {
                        data: ['空号','无法接通','停机','关机','占线','挂断','无人接听','暂停服务']
                    },
                    series: [
                        {
                            name: '失联人数分类',
        ...
        $.ajax({
            url: '/user/DebtLiquidation/GetSexData',
            data: {},
            type: "GET",
            success:function(res){
                //var result = JSON.parse(res);
        ...
        $.ajax({
            url: '/user/DebtLiquidation/GetAgeData',
            data: {},
            type: "GET",
            success:function(res){
                //var result = JSON.parse(res);
        ...
        // 礼包区间
        var myChart5 = echarts.init(document.getElementById('gift'));
        $.ajax({
            url: '/user/DebtLiquidation/GetGiftData',
            data: {},
            type: "GET",
            success:function(res){
                //var result = JSON.parse(res);
        ...
        table.render({
            ...
            cols: [join],
            url: '/user/DebtLiquidation/GetQuanGuoFenBuData?from=list',
            method: 'post',
            response:
                {
                    statusName: 'code',
        ...
        $.ajax({
            url: '/user/DebtLiquidation/GetQuanGuoFenBuData',
            data: {},
            type: "GET",
            success:function(res){
                //var result = JSON.parse(res);
        ...
        $.ajax({
            url: '/user/DebtLiquidation/GetShiJiRenShuData',
            data: {},
            type: "GET",
            success:function(res){
                //var result = JSON.parse(res);
        ...
        table.render({
            ...
            cols: [city],
            url: '/user/DebtLiquidation/GetShiJiRenShuData?from=list',
            method: 'post',
            response:
                {
                    statusName: 'code',
