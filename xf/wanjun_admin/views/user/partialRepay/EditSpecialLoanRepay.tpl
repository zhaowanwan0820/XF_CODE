...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="/user/PartialRepay/EditSpecialLoanRepay" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="project_product_class" id="project_product_class" lay-search="" lay-filter="project_product_class">
                              ...
                              <option value="个体经营贷" <{if $info['project_product_class'] eq '个体经营贷'}>selected<{/if}>>个体经营贷</option>
                              <option value="企业经营贷" <{if $info['project_product_class'] eq '企业经营贷'}>selected<{/if}>>企业经营贷</option>
                              <option value="供应链" <{if $info['project_product_class'] eq '供应链'}>selected<{/if}>>供应链</option>
                              <option value="消费贷" <{if $info['project_product_class'] eq '消费贷'}>selected<{/if}>>消费贷</option>
                            </select>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="project_name_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="loan_repay_type_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="normal_time_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <{if $info['loan_user_id']}>
                        <div class="layui-form-mid layui-word-aux" id="loan_user_id_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                        <{else}>
                    ...
                    <div class="layui-form-item">
                        ...
                        <{if $info['deal_loan_id']}>
                        <div class="layui-form-mid layui-word-aux" id="deal_loan_id_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                        <{else}>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="repayment_total_status"><i class="iconfont" style="color: #259ed8;">&#xe6b1;</i></div>
                    </div>
        ...
        layui.use(['form'], function() {
          ...
          form.on('select(project_product_class)' , function(data){   
            ...
            if (val == '嘉汇' || val == '盈嘉' || val == '盈益') {
              $("#project_product_class_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
            } else {
          ...
          form.on('radio(loan_repay_type)', function(data){
            ...
            if (val == 1 || val == 2 || val == 3) {
              $("#loan_repay_type_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
            } else {
          ...
          form.on('radio(normal_time)', function(data){
            var val=data.value;
            if (val != '') {
              $("#normal_time_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
            } else {
              $("#normal_time_status").html('<i class="iconfont" style="color: #FF5722;">&#xe6b6;</i>');
            }
          });
          ...
          if (project_product_class == '') {
            ...
            $.ajax({
              ...
              success:function(res) {
                if (res['code'] == 0) {
                  $("#deal_name_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                  $("#project_name").val(res['data']['project_name']);
                  $("#project_name_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                  var str   = '';
                  var check = false;
        ...
        function change_loan_user_id(value) {
          if (value != '') {
            $("#loan_user_id_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
          } else {
        ...
        function change_deal_loan_id(value) {
          if (value != '') {
            $("#deal_loan_id_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
          } else {
        ...
        function change_repayment_total(value) {
          if (value != '' && !isNaN(value)) {
            $("#repayment_total_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
          } else {
