...
<script>
    ...
    <script>
      ...
      function daochu()
      {
        ...
        function(index) {
          layer.close(index);
          window.open("/user/PartialRepay/XFPartial2Excel?id=<{$_GET['id']}>&platform_id=<{$_GET['platform_id']}>&name="+name+"&deal_loan_id="+deal_loan_id+"&user_id="+user_id+"&status="+status+"&repay_status="+repay_status , "_blank");
        });
      }
