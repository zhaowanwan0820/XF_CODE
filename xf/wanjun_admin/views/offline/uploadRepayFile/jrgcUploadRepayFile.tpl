...
<div class="layui-fluid">
    <div class="layui-row">
        <{if $end == 0 }>
        <form class="layui-form" method="post" action="/offline/uploadRepayFile/uploadOffline3" id="user_condition_form"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="file" id="template" name="template" autocomplete="off" class="layui-input"
                ...
                <div class="layui-form-mid layui-word-aux"><span class="x-red">*</span>请上传 xls 文件（数据量不可超过一万行）
                    <a href="/upload/工场微金还款计划导入模板.xlsx" style="color: blue;">下载模板</a>
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                            <textarea class="layui-textarea" readonly style="height: 200px">
                                ...
                                总金额：￥<{$total_amount}>
                                成功本金：￥<{$s_wait_capital}>
                                成功利息：￥<{$s_wait_interest}>
                                失败本金：￥<{$f_wait_capital}>
                                失败利息：￥<{$f_wait_interest}>
                            </textarea>
                </div>
            </div>
            <div class="layui-form-item">
