...
/**
 * This is the model class for table "offline_deal".
 *
 * The followings are the available columns in table 'offline_deal':
 * @property integer $id
...
class OfflineDeal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('manager, manager_mobile, object_sn', 'length', 'max'=>50),
	...
	public function search()
	{
		...
		$criteria->compare('open_mail',$this->open_mail);
		$criteria->compare('is_zdx',$this->is_zdx);
		$criteria->compare('object_sn',$this->object_sn,true);
		$criteria->compare('platform_id',$this->platform_id);
		$criteria->compare('repayment_date',$this->repayment_date);
