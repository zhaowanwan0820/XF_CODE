    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="phone" name="phone" readonly="readonly" style="background:#CCCCCC"  required="" value="<{$userInfo['phone']}>" lay-verify="phone"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="L_email" name="email" required="" readonly="readonly" style="background:#CCCCCC"  value="<{$userInfo['email']}>" lay-verify="email"
                           autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input lay-verify="userType" type="radio" name="user_type" value="1" title="普通用户" <{if $userInfo['user_type'] == 1}>checked<{/if}>>
                    <input lay-verify="userType" type="radio" name="user_type" value="2" title="咨询方用户" <{if $userInfo['user_type'] == 2}>checked<{/if}>>
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>
                </div>
