...
<div class="span19" ng-app="myApp" ng-controller="addactionCtrl">
            ...
            <form id="itz-channel-user-form" ng-submit="formsubmit(item)">
                ...
                <div class="row rowSpacing">
                    <label for="iauth_author">权限开发人：</label>
                     <span class="text-middle"> </span>
                    <input class="formMargin" size="50" maxlength="50" name="item[author]" ng-model="item.author" id="iauth_author" type="text" value=""><span class="errorMess" id="phoneerror"></span>
                </div>
                <div class="row rowSpacing">
                    <label>是否双因子：</label>
                ...
                <div class="row rowSpacing">
                    ...
                    <textarea name="item[desc]" ng-model="item.desc" class="formMargin"></textarea>
                </div>
