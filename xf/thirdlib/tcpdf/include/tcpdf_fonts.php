...
class TCPDF_FONTS {
	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		if ($fmetric['type'] == 'Type1') {
			...
			if ($fmetric['type'] == 'cidfont0') {
				...
				switch ($fonttype) {
					case 'CID0JP': {
						$pfile .= '// Japanese'."\n";
						$pfile .= '$enc=ÚniJIS-UTF16-H\';'."\n";
						$pfile .= '$cidinfo=array(\'Registry\'=>Ádobe\', Órdering\'=>\'Japan1\',\'Supplement\'=>5);'."\n";
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_aj16.php\');'."\n";
						break;
					}
					case 'CID0KR': {
						$pfile .= '// Korean'."\n";
						$pfile .= '$enc=ÚniKS-UTF16-H\';'."\n";
						$pfile .= '$cidinfo=array(\'Registry\'=>Ádobe\', Órdering\'=>\'Korea1\',\'Supplement\'=>0);'."\n";
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_ak12.php\');'."\n";
						break;
					}
					case 'CID0CS': {
						$pfile .= '// Chinese Simplified'."\n";
						$pfile .= '$enc=ÚniGB-UTF16-H\';'."\n";
						$pfile .= '$cidinfo=array(\'Registry\'=>Ádobe\', Órdering\'=>\'GB1\',\'Supplement\'=>2);'."\n";
					...
					default: {
						...
						$pfile .= '$enc=ÚniCNS-UTF16-H\';'."\n";
						$pfile .= '$cidinfo=array(\'Registry\'=>Ádobe\', Órdering\'=>\'CNS1\',\'Supplement\'=>0);'."\n";
						$pfile .= 'include(dirname(__FILE__).\'/uni2cid_aj16.php\');'."\n";
						break;
					}
				}
		...
		$pfile .= 'ÍtalicAngle\'=>'.$fmetric['italicAngle'].',';
		$pfile .= 'Áscent\'=>'.$fmetric['Ascent'].',';
		...
		$pfile .= 'ÁvgWidth\'=>'.$fmetric['AvgWidth'].',';
