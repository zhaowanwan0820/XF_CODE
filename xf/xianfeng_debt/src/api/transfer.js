 ...
 * products	是	int	所属产品：1尊享债转 2普惠供应链 3工场微金 4智多新
 * debt_id	否	int	债权记录ID（status=2必传）
 * status	否	int	状态1:发布 2:重新发布
 * */
export const getProInfo = params => fetchEndpoint('/Launch/XfDebtGarden/DebtDetails', 'POST', params)

/**
 * 债权发布接口
 * @param deal_load_id	{int}	投资记录ID
 * @param products	{int}	所属产品：1尊享债转 2普惠供应链 3工场微金 4智多新
 ...
 * */
export const setRelease = params => fetchEndpoint('/Launch/XfDebtGarden/ProjectTransfer', 'POST', params)

/**
 * 个人信息接口
 * @param debt_tender_id	认购债权记录ID
 * @param products		所属产品：1尊享债转 2普惠供应链 3工场微金 4智多新
 * */
export const getUserInfo = params => fetchEndpoint('/Launch/XfDebtGarden/PayeeInfo', 'POST', params)
 ...
 * */
export const setCertificate = params => fetchEndpoint('/Launch/XfDebtGarden/TransferPayment', 'POST', params)
 ...
 * */
export const setRepublish = params => fetchEndpoint('/Launch/XfDebtGarden/AgainProjectTransfer', 'POST', params)
