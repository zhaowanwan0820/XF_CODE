    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button type="button" class="layui-btn layui-btn-warm" onclick="xadmin.open('新增','/iauth/user/ComapnyUserAdd',600,400)"><i class="layui-icon"></i>新增</button>
                </div>
                <div class="layui-card-body ">
                            ...
                            <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a onclick="member_stop(this,<{$val['id']}>)" href="javascript:;"  title="<{$val['status_info']}>">
                                        <{if $val['status_info'] == '已启用' }>
                                        <button class="layui-btn layui-btn-danger">停用账号</button>
                                        <{else}>
                                        <button class="layui-btn layui-btn-danger" style="background-color:#5fb733 ">启用账号</button>
                                        <{/if}>
...
<script>
    ...
    function member_stop(obj,id){
        if($(obj).attr('title')=='已启用'){var str = "停用";}else{var str = "启用";}
