 ...
 */
class Firstp2pEnterprise extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Firstp2pEnterprise the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('user_id, credentials_type, is_permanent, legalbody_credentials_type, indu_cate', 'numerical', 'integerOnly'=>true),
