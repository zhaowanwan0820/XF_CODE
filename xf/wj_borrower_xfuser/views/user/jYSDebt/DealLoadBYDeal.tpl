                                ...
                                <form class="layui-form" action="">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="deal_name" id="deal_name" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="user_name" id="user_name" placeholder="请输入发行人/融资方简称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
                                      ...
                                      <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                          <select name="type" lay-search="">
                                            ...
                                            <option value="1">上传发行人/融资方简称</option>
                                          </select>
                                        </div>
                                      </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/JYSDebt/DealLoadBYDeal',
          method   : 'post',
          where    : {deal_type : 5},
          response :
          {
        ...
        form.on('submit(sreach_a)', function(obj){
          ...
          if (obj.field.type == 0) {
            ...
            xadmin.open('通过上传发行人/融资方简称查询','/user/JYSDebt/addDealLoadBYDealCondition?deal_type=5&type=1');
          }
          return false;
        });
      ...
      function DealLoadBYDeal2ExcelA()
      {
        ...
        if (deal_id == '' && deal_name == '' && project_id == '' && project_name == '' && jys_record_number == '' && user_name == '' && advisory_name == '' && agency_name == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/JYSDebt/DealLoadBYDeal2Excel?deal_type=5&deal_id="+deal_id+"&deal_name="+deal_name+"&project_id="+project_id+"&project_name="+project_name+"&jys_record_number="+jys_record_number+"&user_name="+user_name+"&advisory_name="+advisory_name+"&agency_name="+agency_name , "_blank");
          });
        }
      }
      ...
      function DealLoadBYDeal2ExcelB()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/JYSDebt/DealLoadBYDeal2Excel?deal_type=5&condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
