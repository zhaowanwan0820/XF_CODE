              ...
              success:function(res){
                if (res['code'] === 0) {
                  if (res['data']['idno_res'] == 0) {
                    ...
                    $("#idno_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                  }
                  if (res['data']['old_mobile_res'] == 0) {
                    $("#old_mobile_status").html('<i class="iconfont" style="color: #FF5722;">&#xe6b6;</i>');
                  } else {
                    $("#old_mobile_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                  }
                  if (res['data']['user_id'] == 0 || res['data']['real_name'] == '') {
                    ...
                    $("#real_name_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                  }
                } else {
                  $("#user_id").val('');
                  $("#real_name").val('');
            ...
            $.ajax({
              ...
              success:function(res){
                if (res['code'] === 0) {
                  ...
                  $("#new_mobile_status").html('<i class="iconfont" style="color: #259ed8;">&#xe6b1;</i>');
                } else {
                  check_new_mobile = false;
