...
<html class="x-admin-sm">
                                  ...
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        <div class="layui-input-block">
                                          ...
                                          <{if $DebtLiquidationUserStatistics2Excel == 1 }>
                                          <button type="button" class="layui-btn layui-btn-danger" onclick="DebtLiquidationUserStatistics2Excel()">导出</button>
                                          <{/if}>
                                        </div>
                                      </div>
                                    </form>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          cols:[[
            ...
            {
              field : 'kpi_1_user_day',
              title : 'KPI记数分区1当日下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_1_user',
              title : 'KPI记数分区1累计下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_1_user_percent',
              title : 'KPI记数分区1累计完成比',
              align : 'right',
              width : 190
            },
            ...
            {
              field : 'kpi_2_user_day',
              title : 'KPI记数分区2当日下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_2_user',
              title : 'KPI记数分区2累计下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_2_user_percent',
              title : 'KPI记数分区2累计完成比',
              align : 'right',
              width : 190
            },
            ...
            {
              field : 'kpi_3_user_day',
              title : 'KPI记数分区3当日下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_3_user',
              title : 'KPI记数分区3累计下车人数',
              align : 'right',
              width : 180
            },
            {
              field : 'kpi_3_user_percent',
              title : 'KPI记数分区3累计完成比',
              align : 'right',
              width : 190
            },
          ]],
          url      : '/user/DebtLiquidation/DebtLiquidationUserStatistics',
          method   : 'post',
      ...
      function DebtLiquidationUserStatistics2Excel()
      {
        var start     = $("#start").val();
        var end       = $("#end").val();
        if (start == '' && end == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/DebtLiquidation/DebtLiquidationUserStatistics2Excel?start="+start+"&end="+end , "_blank");
          });
        }
      }
    </script>
