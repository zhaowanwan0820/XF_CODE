                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <input type="text" name="deal_id" placeholder="请输入产品编号" autocomplete="off" class="layui-input" value="">
                                          </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <input type="text" name="deal_name" placeholder="请输入产品名称" autocomplete="off" class="layui-input" value="">
                                          </div>
                                        </div>
                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <input type="text" name="real_name" placeholder="请输入发行人/融资方简称" autocomplete="off" class="layui-input" value="">
                                          </div>
                                        </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/JYSRepayment/LoanRepayList',
          method   : 'post',
          response :
          {
            statusName : 'code',
        ...
        table.on('tool(list)' , function(obj){
          ...
          if (layEvent === 'add')
          {
            xadmin.open('添加线下还款' , '/user/JYSRepayment/StartLoanRepay?id='+data.id);
      ...
      function dao_chu(id) {
        ...
        function(index) {
          layer.close(index);
          window.open("/user/JYSRepayment/LoanRepayListExcel?stat_repay_id="+id , "_blank");
        });
      }
    </script>
