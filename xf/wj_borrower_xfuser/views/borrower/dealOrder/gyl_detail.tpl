        ...
        <div class="layui-col-md12">
                ...
                <div class="layui-card-body ">
                    <div class="layui-tab layui-tab-brief" lay-filter="table-all">
                        <ul class="layui-tab-title">
                            <li data-status="0" class="layui-this" style="font-size: 14px;" id='repay_log' onclick="repayLogShow()">还款计划表</li>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <div class="layui-tab layui-tab-brief" lay-filter="table-all">
                        <ul class="layui-tab-title">
                            <li data-status="0" class="layui-this" style="font-size: 14px;" id='repay_log' onclick="repayLogShow()">还款记录</li>
                            <!-- <li data-status="1" id='modify_log' style="font-size: 14px;" onclick="modifyLogShow()">修改记录</li> -->
                        </ul>
                    </div>
                    <table class="layui-table layui-form" id="repayLogTable">
                        ...
                        <{if $repayPlan}>
                            ...
                            <tr>
                                <td><{$val['repay_time']}></td>
                                <td><{$val['repay_capital']}></td>
                                <td><{$val['surplus_repay_capital']}></td>
                                <td><{$val['total_repay_capital']}></td>
                                <td><{$val['reply_slip_html']}></td>
                                <td><{$val['repay_content']}></td>
                            </tr>
                            <{/foreach}>
                            <{else}>
