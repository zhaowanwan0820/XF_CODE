                            ...
                            <div class="layui-colla-content layui-show">
                                <form class="layui-form" >
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">借款方手机号</label>
                                            <div class="layui-input-inline">
    ...
    layui.use(['laydate', 'table', 'layer', 'form'], function () {
        ...
        var join = [
           ...
           // {field: 'repay_type', title: '借款期限', width: 80},
            ...
            {field: 'user_id', title: '借款方ID', width: 120},
        ...
        table.render({
            ...
            autoSort: false,
            cols: [join],
            url: '/borrower/DealOrder/gylIndex',
            method: 'post',
            response:
                {
                    statusName: 'code',
        ...
        form.on('submit(export)', function (where) {
            ...
            layer.confirm('确认要根据当前筛选条件导出吗？',
                function (index) {
                    layer.close(index);
                    location.href = "/borrower/DealOrder/gylIndex?execl=1" +
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'detail') {
                xadmin.open('详情', '/borrower/DealOrder/gylRepayPlan?deal_id=' + data.id );
