...
<script>
    layui.use(['laydate', 'table', 'layer', 'form'], function () {
        ...
        var join = [
            ...
            {field: 'data_src_cn', title: '借款来源', width: 120},//todo  
            {field: 'borrow_amount', title: '原借款金额', width: 120},
            {field: 'rate', title: '原借款利率', width: 120},
            {field: 'repay_type', title: '原借款期限', width: 120},
            {field: 'un_puy_num', title: '原未还期数', width: 120},//todo 
            {field: 'principal', title: '原待还本金和', width: 120},
            {field: 'interest', title: '原待还利息和', width: 120},
            {field: 'new_principal', title: '新待还本金和', width: 120},//todo 
            {field: 'new_interest', title: '新待还利息和', width: 120},//todo   
            {field: 'jianmian', title: '合计减免金额', width: 120},//todo   
            {field: 'new_un_puy_num', title: '新未还期数', width: 120},//todo  
            {field: 'xf_last_repay_time', title: '最近新还款日期', width: 120},//todo  
            {field: 'add_user_name', title: '创建账号', width: 120},//todo  
        ...
        table.render({
            ...
            autoSort: false,
            cols: [join],
            url: '/borrower/DealOrder/NewIndex',
            method: 'post',
            response:
                {
                    statusName: 'code',
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'detail') {
                xadmin.open('还款计划', '/borrower/DealOrder/newRepayPlan?deal_id=' + data.id );
