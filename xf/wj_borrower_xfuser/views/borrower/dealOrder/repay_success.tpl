                                ...
                                <form class="layui-form" >
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">归属第三方公司</label>
                                            <div class="layui-input-inline">
                                                <select name="cs_company" id="cs_company" lay-search="">
                                                    <option value=0 >请选择</option>
                                                    <{foreach $cs_company as $key => $val}>
...
<script>
    layui.use(['laydate', 'table', 'layer', 'form'], function () {
        ...
        var join = [
            ...
            {field: 'cs_company', title: '归属第三方公司', width: 180},
            {field: 'deal_name', title: '借款标题', width: 140},
            {field: 'deal_id', title: '借款编号', width: 120},
            {field: 'data_src_cn', title: '借款来源', width: 140}, 

            // {field: 'rate', title: '利率', width: 60},
            // {field: 'repay_type', title: '借款期限', width: 80},
            {field: 'principal', title: '应还本金',width: 150},
            {field: 'paid_principal', title: '已还本金',width: 150},
            {field: 'paid_principal_time', title: '本金还款时间', width: 150}, 
            {field: 'interest', title: '应还利息', width: 150},
            {field: 'paid_interest', title: '已还利息', width: 150},
            {field: 'paid_interest_time', title: '利息还款时间', width: 150}, 
            {field: 'paid_type', title: '划扣还款类型', width: 150},
                ...
                where:
                    {
                        ...
                        cs_company: obj.field.cs_company,
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (layEvent === 'detail') {
                xadmin.open('还款计划', '/borrower/DealOrder/NewRepayPlan?from_repay_success=1&deal_id=' + data.deal_id );
