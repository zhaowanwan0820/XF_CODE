...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/borrower/DealOrder/addRefund" enctype="multipart/form-data" id="my_form">

                    <div class="layui-form-item">
                        <label for="debt_account" class="layui-form-label">
                            <span class="x-red">*</span>退款金额
                        </label>
                        <div class="layui-input-inline">
                            <input type="text" id="amount" name="amount" value="<{$new_principal}>" lay-verify="number" disabled class="layui-input">
                        </div>
                    </div>

                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>退款日期
                        </label>
                        <div class="layui-input-inline">
                            <input class="layui-input" name="refund_date" placeholder="2021-01-01" lay-verify="date" autocomplete="off" id="refund_date" >
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <button type="submit" class="layui-btn" onclick="add()">增加</button>
                    </div>
                </form>
            </div>
        </div>
