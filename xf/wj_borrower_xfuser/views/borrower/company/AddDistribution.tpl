...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/borrower/company/AddDistribution" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item" id="d_type_div">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>分案类型</label>
                        <div class="layui-input-inline">
                            <input type="radio" name="d_type" value="0" title="借款方" lay-filter="d_type" checked>
                            <input type="radio" name="d_type" value="1" title="担保企业" lay-filter="d_type">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" id="company_type_div" style="display: none;">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>分配担保公司</label>
                        <div class="layui-input-inline">
                            <input type="radio" name="s_type_company" value="1" title="单独分配" lay-filter="s_type" checked >
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item" id="file_path_div" style="display: none;">
                        ...
                        <div class="layui-form-mid layui-word-aux"><span class="x-red">*</span>请上传 xls 文件（数据量不可超过100000行） <a href="/borrower/company/AddDistribution?download=1" style="color: blue;">下载模板</a></div>
                    </div>

                    <div class="layui-form-item"  id="user_id_div"  >
                        <label for="pay_user" class="layui-form-label">
                            <span class="x-red">*</span>借款方ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="user_id" name="user_id" autocomplete="off" class="layui-input"></div>
                    </div>

                    <div class="layui-form-item"  id="agency_id_div"  style="display: none;">
                        <label for="pay_user" class="layui-form-label">
                            <span class="x-red">*</span>担保公司ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="agency_id" name="agency_id" autocomplete="off" class="layui-input"></div>
                    </div>
        ...
        layui.use(['layedit', 'form', 'layer' , 'laydate'] , function() {
            ...
            form.on('radio(d_type)', function(data){
                var val2=data.value;
                $("#user_id").val('');
                if (val2 == 0) {
                    $("#company_type_div").prop('style','display: none;');
                    $("#user_id_div").prop('style','');
                    $("#s_type_div").prop('style','');
                    $("#agency_id_div").prop('style','display: none;');
                } else if (val2 == 1) {
                    $("#company_type_div").prop('style','');
                    $("#s_type_div").prop('style','display: none;');
                    $("#file_path_div").prop('style','display: none;');
                    $("#user_id_div").prop('style','display: none;');
                    $("#agency_id_div").prop('style','');
                }
            });
        ...
        function do_add() {
          ...
          // } else if (proof == '') {
            // layer.alert('请选择还款凭证');
              ...
              // } else if (proof == '') {
              // layer.alert('请选择还款凭证');
          }  else if (file_path == '' && user_id == '' && agency_id=='') {
