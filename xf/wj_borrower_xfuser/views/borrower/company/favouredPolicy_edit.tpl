...
<div class="layui-fluid">
    <div class="layui-row layui-col-space15">
        <form class="layui-form" method="post" action="/borrower/company/FavouredPolicyEdit" enctype="multipart/form-data" id="my_form">
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-form-item" style="text-align: center">
                    <button type="button" class="layui-btn" onclick="add()" style="margin-right: 20px;">保存</button>
                    <a href='/borrower/company/favouredPolicy'>
