...
/**
 * This is the model class for table "firstp2p_deal_project".
 *
 * The followings are the available columns in table 'firstp2p_deal_project':
 * @property integer $id
 ...
 */
class PHDealProject extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return DealProject the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('rate, intro, approve_number, credit', 'required'),
			array('user_id, risk_bearing, loantype, repay_time, create_time, update_time, deal_type, status, borrow_fee_type, loan_money_type, card_type, bank_id, entrust_sign, entrust_agency_sign, entrust_advisory_sign, fixed_value_date, business_status, clearing_type', 'numerical', 'integerOnly'=>true),
