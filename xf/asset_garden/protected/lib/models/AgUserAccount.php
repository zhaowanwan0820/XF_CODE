...
/**
 * This is the model class for table "ag_user_account".
 *
 * The followings are the available columns in table 'ag_user_account':
 * @property string $id
 ...
 */
class AgUserAccount extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AgUserAccount the static model class
	 */
