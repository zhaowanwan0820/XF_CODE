...
/**
 * This is the model class for table "xf_debt_exchange_auth_user".
 *
 * The followings are the available columns in table 'xf_debt_exchange_auth_user':
 * @property integer $id
 ...
 */
class XfDebtExchangeAuthUser extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return XfDebtExchangeAuthUser the static model class
	 */
	...
	{
		return 'xf_debt_exchange_auth_user';
	}
