 ...
 */
class OfflineDebtExchangeLog extends CActiveRecord
{
    /**
    ...
    {
        return 'offline_debt_exchange_log';
    }
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('contract_transaction_id,area_id,buyer_uid,new_deal_load_id,platform_no,platform_id,order_sn,order_info,return_time,debt_src,buyer_uid,id, user_id, tender_id, order_id, debt_account, addtime, status, successtime, borrow_id, return_status', 'safe', 'on'=>'search'),
        );
    }
