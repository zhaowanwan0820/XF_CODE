...
class XfGiftExchange extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('kpi_1_real_user,kpi_2_real_user,kpi_3_real_user,id,name,exchange_min,exchange_max,plan_liquidation_user,liquidation_user,plan_yr_debt_total,yr_debt_total,plan_debt_total,debt_total,plan_liquidation_cost,liquidation_cost,avg_proportion,avg_debt,avg_liquidation_cost,kpi_1_min,kpi_1_max,kpi_1_plan_user,kpi_2_min,kpi_2_max,kpi_2_plan_user,kpi_3_min,kpi_3_max,kpi_3_plan_user', 'safe', 'on'=>'search'),
		);
	}
