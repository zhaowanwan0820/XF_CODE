 ...
 */
class PHDebtTender extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('exclusive_purchase_id,submit_paytime,cancel_time,payer_name,payer_bankzone,payer_bankcard,payment_voucher,id, debt_id, user_id, new_tender_id, type, status, money, account, action_money, addtime, addip, debt_type', 'safe', 'on'=>'search'),
		);
	}
