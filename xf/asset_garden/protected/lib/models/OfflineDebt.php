 ...
 */
class OfflineDebt extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('displace_id,exclusive_purchase_id,platform_no,platform_id,email_notice_id,is_mail,payee_name,payee_bankzone,payee_bankcard,buy_code,id, user_id, debt_src, tender_id, borrow_id, type, status, money, sold_money, discount, scale, real_apr_s, real_apr_b, starttime, endtime, next_repay_time, successtime, addtime, addip, repayment_time, serial_number, renew_status, borrow_apr, debt_type, borrow_repay_scale, arrival_amount, repay_status', 'safe', 'on'=>'search'),
		);
	}
