<template>
    <div class="container">
        <div class="trans-title">
            ...
            <p>请于<van-count-down :time="params.undertake_endtime*1000" style="display: inline-block;"/> 秒进行支付并提交转账信息。</p>
        </div>
        <div class="seller">
            ...
            <div class="seller-box" @click="isCopy(params.payee_bankzone)">
                <label>开户行</label>
  ...
  export default {
    ...
    methods:{
      ...
      submit(){
        ...
        this.$loading.open()
        setCertificate(this.form).then(res=>{
          // console.log(res)
          this.$loading.close();
          if(res.code == 0){
            this.$toast(res.info)
