    ...
    <div class="release-box">
      ...
      <div class="form-conter">
        ...
        <div class="form-flex">
          ...
          <div class="form-input">
            <input type="Number" placeholder="请输入4~10的数字" v-model.Number="form.discount" @input="inputBlur" />
          </div>
          <span>折</span>
        </div>
        <div class="form-flex">
  ...
  methods: {
    ...
    submit() {
      ...
      if (!discount) {
        ...
        if (Number(discount) < 4 || Number(discount) > 10 || Number(discount) < 0) {
          Toast('请重新确认债转折扣，应为4~10的数字！')
          return false
        }
      }
