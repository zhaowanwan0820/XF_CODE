...
axios.interceptors.request.use(
  config => {
    ...
    if (isAPIRequest) {
      ...
      // config.headers['X-HH-AUTHORIZATION'] = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1aWQiOjE1OTA3LCJoYXNoaWQiOiIyMDY1NTcxIiwiZXhwIjoxNTgzMjI0MjMzfQ.cd_J_orhmXnHW7KXV158YGyQ7XGkCnRwSyZMY9BJznE'
