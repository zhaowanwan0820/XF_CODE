...
class ApiWeekStatisticsModel extends BaseModel
{
    ...
    public function updateLogById($params)
    {
        ...
        $sql = sprintf("UPDATE api_week_statistics SET request_num = request_num + 1, update_time = %d WHERE id = %d", time(), $params['id']);
