...
class ReservationCardService extends BaseService
{
     ...
     * @return \libs\db\model
     */
    public function getReserveCardList($limit = 10, $status = ReservationCardModel::STATUS_VALID,$offset=0, $dealTypeList = [], $userInfo = [])
    {
        ...
        if ($cards) {
            ...
            $config = $reserveConf->getReserveInfoByType(ReservationConfModel::TYPE_CONF);
            ...
            foreach ($cards as $card) {
                ...
                $item['investUnit'] = UserReservationModel::$investDeadLineUnitConfig[intval($card['invest_unit'])];
     ...
     * @return \libs\db\model
     */
    public function getReserveCardCount($status = ReservationCardModel::STATUS_VALID){
     ...
     * @return \libs\db\model
     */
    public function getReserveCardListByAdmin( $status = ReservationCardModel::STATUS_VALID)
    {
     ...
     * @return \libs\db\model
     */
    public function getReserveCardDetail($line_unit, $status = ReservationCardModel::STATUS_VALID, $dealType = null)
    {
