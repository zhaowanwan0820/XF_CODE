...
class DtCancelService {
    ...
    public function getCanCancelDealLoans($userId) {
        ...
        $response =$rpc->go( 'NCFGroup\Duotou\Services\DealLoanCancel', 'getCanCancelDealLoans', $request);
        if(empty($response)){
            return $return;
        }
    ...
    public function cancelDealLoan($userId,$loanId) {
        ...
        $request->setVars($vars);
        $rpc = new Rpc('duotouRpc');
        $response =$rpc->go( 'NCFGroup\Duotou\Services\DealLoanCancel', 'cancelDealLoan', $request);
    ...
    public function canCancelToday($userId) {
        ...
        $request->setVars($vars);
        $rpc = new Rpc('duotouRpc');
        $response =$rpc->go( 'NCFGroup\Duotou\Services\DealLoanCancel', 'canCancelToday', $request);
