...
class AgencyImageService extends BaseService
{
    ...
    {
        $sign_img_obj = AgencyImageModel::instance()->getAgencyImgInfoOfTheType($agency_id, AgencyImageModel::AGENCY_IMAGE_TYPE_SIGN);
