...
/**
 * 黄金投标并发用户锁
 * GoldDealData class file
 * @author wangzhen <wangzhen@ucfgroup.com>
 */

namespace core\data;
use core\service\DealLoadService;
class GoldDealData extends BaseData {
    private $_arr_income_view = array("key"=>"gold_income_view_", "time"=>172800);
    private $_arr_links = array("key"=>"gold_links", "time"=>600);
    private $_arr_deal_oplock = array("key"=>"gold_deal_oplock_", "time"=>180);
    private $_arr_deal_times_counter = array("key"=>"gold_deal_times_counter_", "time"=>10);
    private $_arr_credit_china_data = array('key'=>'gold_deal_log_','list_max'=>1000, 'time'=>86400);
    private $_arr_deal_oplock_pool = array('key'=>'gold_deal_oplock_pool_', 'time'=>90);
    ...
    */
    public function enterPool($deal_id){
        $dealPoolSize = app_conf('GOLD_DEAL_POOL_SIZE');
