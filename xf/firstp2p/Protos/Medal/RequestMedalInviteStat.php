 ...
 */
class RequestMedalInviteStat extends AbstractRequestBase
{
    /**
     * 邀请人的ID
     *
     ...
     * @return int
     */
    public function getInvesterId()
    {
        return $this->investerId;
    }

    /**
     * @param int $investerId
     * @return RequestMedalInviteStat
     */
    public function setInvesterId($investerId)
    {
        \Assert\Assertion::integer($investerId);
