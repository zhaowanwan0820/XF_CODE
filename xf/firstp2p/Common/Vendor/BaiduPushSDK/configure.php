...
class BAIDU_PUSH_CONFIG {
     ...
     * @var string
     */
    const default_apiKey = 'zMoc14qulm74SCeI4MXwgGkH';
     ...
     * @var string
     */
    const default_secretkey = 'ZnTe1GaWop9v9svfNwsSoyiLSkwL1QXU';
     ...
     * @var int
     */
    const LOG_LEVEL = BAIDU_PUSH_CONFIG::LOG_LEVEL_ONLINE_SILENCE;
