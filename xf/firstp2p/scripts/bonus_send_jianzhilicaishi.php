...
$bonus_group_total = app_conf('BONUS_PUSH_TOTAL');//每人收到的红包组个数
...
//定向用户组发红包
$sql = "SELECT `id`,`real_name`,`mobile` FROM ".DB_PREFIX."user WHERE `group_id` = 13 AND coupon_level_id=115 AND `is_effect` =1 AND `is_delete` =0 ORDER BY `id` ASC ";
