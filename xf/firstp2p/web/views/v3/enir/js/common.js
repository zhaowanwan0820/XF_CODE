...
if(pathname == '/en/companyProfile' || pathname == '/en/financeProcess' || pathname == '/en/historyTimeline' || pathname == '/en/honor' || pathname == '/en/socialResponse'){
    pathname = '/en/aboutNcf'
}
if(pathname == '/en/coreBusiness' || pathname == '/en/riskControl' || pathname == '/en/competitiveAdvantages'){
    pathname = '/en/core'
}
if(pathname == '/en/articleDetail'){
    pathname = '/en/mediaCoverage'
}
