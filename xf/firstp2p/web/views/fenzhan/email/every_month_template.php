...
<meta name="keywords" content="网信理财，p2p，网络借贷，网络贷款，借贷 ，网络平台，民间借贷，小额贷款，无抵押贷款，信用贷款，投资理财，借钱，企业贷款，小企业贷款，个人经营贷款，融资" />
<meta name="description" content="网信理财 — 安全，专业的网络借款、理财平台。提供便捷、安全、低门槛的个人信用贷款和个人理财服务。" />
...
?>
                ...
                <tr style="background:#e7f5ff; color:#848484">
                    <td style="padding:0 0 10px 40px;font-family:Microsoft YaHei"><span style="font-size:18px;"><i class="icon_e_keyong" style="vertical-align:middle;">
                        <img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v1/images/email/icon_03.png',1);?>"></i><span style="padding-left: 10px;  height:40px; vertical-align:middle">可用余额：<?php echo format_price($user_info['money']);?></span></span></td>
                    <td style="padding:0 0 10px 0px;font-family:Microsoft YaHei"><span style="font-size:18px;"><i class="icon_e_benjin" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v1/images/email/icon_06.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">待收本金：<?php echo format_price($user_statics['principal'])?></span></span></td>
                </tr>
                <tr style="background:#e7f5ff; color:#848484">
                	<td  style="padding:0 0 10px 40px;font-family:Microsoft YaHei" ><div  style=" padding-bottom:20px;font-family:Microsoft YaHei"><span style="font-size:18px;font-family:Microsoft YaHei"><i class="icon_e_dongjie" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v1/images/email/icon_04.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">冻结金额：<?php echo format_price($user_info['lock_money']);?></span></span></div></td>
                	<td style="padding:0 0 10px 0px;font-family:Microsoft YaHei"><div  style=" padding-bottom:20px;"><span style="font-size:18px;"><i class="icon_e_daishou" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v1/images/email/icon_05.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">待收收益：<?php echo format_price($user_statics['interest']);?></span></span></div></td>
                </tr>
            </tbody>
        </table>
        </div>
            ...
            <table width="100%" style="border:1px solid #dedede; font-size:14px;" border="0" cellspacing="0" cellpadding="0">
            	...
            	<thead>
                	<tr style="background:#dedede; line-height:30px; height:30px ;color:#848484">
                        ...
                        <td><div style="text-align: left;font-size:14px;">账户余额(元)</div></td>
                ...
                if(count($detail)) {
                    foreach ($detail as $key => $val) {
                        ...
                        $str .= "<td style=\"text-align:center;font-size:14px;font-family:Microsoft YaHei\">".format_price($val['remaining_money'],false)."</td>
                                            <td><div style=\"text-align: center;font-size:14px;padding:5px 0px;font-family:Microsoft YaHei\">".$val['note']."</div></td>
                                        </tr>";
                        echo $str;
                    }
                }else {
...
<tr>
    ...
    <div class="email_footer" style="width:540px; margin:0px auto; font-size:16px; color:#7f7f7f;">
    	如您对上述内容有疑问，请致电网信理财平台客户服务热线400-890-9888，
		或登录您的<a href="<?php echo $main_site;?>/" style="text-decoration:none; color:#0088cc; outline:none;">网信理财</a>平台账户进行查询。
		<table width="540">
		  <tr>
		      <td align="center">
                  <a href="<?php echo $main_site;?>/" title="网信理财" style="width:150px; height:40px; display:block; border:0px; margin:30px auto 50px;">
                    <img src="<?php echo $asset->makeUrl('/v1/images/email/logo_wx.png?v=20140902',1); ?>" style="border:none 0px;"></a>
		      </td>
		  </tr>
		</table>
