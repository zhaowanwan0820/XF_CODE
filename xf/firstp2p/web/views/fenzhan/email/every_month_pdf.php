                ...
                if(count($detail)) {
                    foreach ($detail as $key => $val) {
                        ...
                        $str .= "<td style=\"text-align:center;font-size:14px;font-family:Microsoft YaHei\">".format_price($val['remaining_money'],false)."</td>
                                            <td><div style=\"text-align: center;font-size:14px;padding:5px 0px;font-family:Microsoft YaHei\">".$note."</div></td>
                                        </tr>";
                        echo $str;
                    }
                }else {
...
<tr>
    ...
    <div class="email_footer" style="width:540px; margin:0px auto; font-size:16px; color:#7f7f7f;">
		...
		<table width="540">
		  <tr>
		      <td align="center">
		          <a class="e_logo" href="<?php echo $main_site;?>/" title="网信理财" style="width:150px; height:40px; display:block; border:0px; margin:30px auto 50px;"><img src="<?php echo $site;?>/v1/images/email/logo_wx.png" style="border:none 0px;"></a>
		      </td>
		  </tr>
		</table>
