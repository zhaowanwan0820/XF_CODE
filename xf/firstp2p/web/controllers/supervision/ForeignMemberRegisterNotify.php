...
class ForeignMemberRegisterNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("Supervision foreignMemberRegisterNotifyCallback Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));

        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log("Supervision foreignMemberRegisterNotifyCallback redirect.");
            return app_redirect('/');
        }
        ...
        PaymentApi::log('Supervision foreignMemberRegisterNotifyCallback Request params decode:' . json_encode($requestData));
