...
class EnterpriseRegisterNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("Supervision enterpriseRegisterNotifyCallback Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));

        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log('Supervision enterpriseRegisterNotifyCallback redirect.');
            return app_redirect('/');
        }
        ...
        PaymentApi::log('Supervision enterpriseRegisterNotifyCallback Request params decode:' . json_encode($requestData));
