...
class BookCreditBatchNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("SupervisionDT bookCreditBatchNotifyCallback Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));
        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log('SupervisionDT bookCreditBatchNotifyCallback redirect.');
            return app_redirect('/');
        }
        ...
        // 逻辑处理
        $result = $this->rpc->local('DtPaymenyService\bookCreditBatchNotify', [$params]);
