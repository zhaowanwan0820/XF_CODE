...
class RegisterNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("Supervision registerNotifyCallback Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));

        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log("Supervision registerNotifyCallback redirect.");
            return app_redirect('/');
        }
        ...
        PaymentApi::log('Supervision registerNotifyCallback Request params decode:' . json_encode($requestData));
