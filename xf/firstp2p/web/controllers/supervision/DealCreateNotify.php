...
class DealCreateNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("Supervision dealCreateNotifyCallback Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));

        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log("Supervision dealCreateNotifyCallback redirect.");
            return app_redirect('/');
        }
        ...
        PaymentApi::log('Supervision dealCreateNotifyCallback Request params decode:' . json_encode($requestData));
