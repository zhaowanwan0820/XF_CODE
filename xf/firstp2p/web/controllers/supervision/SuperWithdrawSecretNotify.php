...
class SuperWithdrawSecretNotify extends BaseAction
{
    ...
    {
        //参数获取
        PaymentApi::log("Supervision SuperWithdrawSecretNotify Request. method:{$_SERVER['REQUEST_METHOD']}, params:".json_encode($_POST));

        if ($_SERVER['REQUEST_METHOD'] !== 'POST')
        {
            PaymentApi::log("Supervision SuperWithdrawSecretNotify redirect.");
            return app_redirect('/');
        }
        ...
        PaymentApi::log('Supervision SuperWithdrawSecretNotify Request params decode:' . json_encode($requestData));
        ...
        // 逻辑处理
        $result = $this->rpc->local('SupervisionFinanceService\superWithdrawNotify', [$params]);
