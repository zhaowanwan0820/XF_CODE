...
class Finplan extends BaseAction {
    ...
    public function invoke() {
        ...
        foreach ($list as &$value) {
            if($value['activityId'] > 0) { //参与了活动
                ...
                if(isset($activityInfos[$activityId])) {
                    ...
                    $activityInfo = DuotouService::GetEntranceInfo($activityId);
                    //$activityInfo = $this->rpc->local('DtEntranceService\getEntranceInfo',array($activityId));
        ...
        $this->tpl->assign("ncfph_domain","//".app_conf('NCFPH_DOMAIN'));
