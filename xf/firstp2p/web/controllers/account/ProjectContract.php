...
class ProjectContract extends BaseAction {
    ...
    public function init() {
        \es_session::set('before_login','/account/project_contract');
        $this->check_login();
    ...
    public function invoke() {
        ...
        $result = $this->rpc->local('ContractNewService\getContProjectList', array($user_id, $page_num,10,$role));
        if (false === $result) {
        ...
        $this->tpl->assign ( "inc_file", 'web/views/account/project_contract.html' );
