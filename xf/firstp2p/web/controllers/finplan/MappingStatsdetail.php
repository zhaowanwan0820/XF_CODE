...
class MappingStatsdetail extends BaseAction {
    ...
    public function invoke() {
        ...
        $userId = $user['id'];
        $res = \SiteApp::init()->dataCache->call($this->rpc, 'local', array('DtP2pMappingStatsService\getP2pDealMappingStatsDetail', array($userId,$dealId,$mappingDate,$pageNum,$pageSize),'duotou'), 30);
