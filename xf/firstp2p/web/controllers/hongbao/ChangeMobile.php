...
class ChangeMobile extends HongbaoBase {
    ...
    public function init() {
        ...
        if (!$ajax) {
            ...
            $this->template = "web/views/hongbao/changemobile.html";
            return false;
        } else {
    ...
    public function invoke() {
        ...
        $this->bonusGroupInfo = \SiteApp::init()->dataCache->call($this->rpc, 'local', array('BonusService\get_group_info_by_sn', array($this->sn)), 10);
