 ...
 * 企业用户找回密码
 */
class CheckLegalbodyCredentials extends BaseAction {
    public function init() {
        $this->form = new Form('post');
        $this->form->rules = array(
            'legalbody_credentials_no' => array('filter' => 'required', 'message' => '法定代表人证件号为空')
        );
    ...
    public function invoke() {
        ...
        if ($data['legalbody_credentials_no'] !== $userinfo['base']['legalbody_credentials_no']) {
            $ret['code'] = '3';
