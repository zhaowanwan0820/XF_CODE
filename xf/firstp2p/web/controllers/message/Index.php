...
class Index extends BaseAction {
    ...
    public function invoke() {
        ...
        //$list = MsgBoxModel::instance()->getMsgBoxList($user_id);
        ...
        //取消息
        foreach($list as $k=>$v) {
            // $list[$k] =MsgBoxModel::instance()->getMsgBoxRow($v['group_key'],$user_id);
        ...
        //$systemNum = MsgBoxModel::instance()->getuserMsgCount($user_id);
        if (!$this->is_firstp2p) {
