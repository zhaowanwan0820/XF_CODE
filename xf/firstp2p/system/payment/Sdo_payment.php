...
class Sdo_payment implements payment{
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$postBackURL = get_domain().APP_ROOT.'/index.php?ctl=payment&act=response&class_name=Sdo';//付款完成后的跳转页面
		$notifyURL = get_domain().APP_ROOT.'/index.php?ctl=payment&act=notify&class_name=Sdo';//通知发货页面
		$backURL = '';
		$currencyType = "RMB";
