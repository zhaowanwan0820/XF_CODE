...
{
	return app_redirect(APP_ROOT."/install/index.php");
}
...
$pconnect = false;
$db = new libs\db\MysqlDb(app_conf('DB_HOST').":".app_conf('DB_PORT'), app_conf('DB_USER'),app_conf('DB_PWD'),app_conf('DB_NAME'),'utf8',$pconnect);
//end 定义DB
...
//自动生成runtime/admin文件
if(!file_exists(APP_ROOT_PATH.'public/runtime/admin/'))
	mkdir(APP_ROOT_PATH.'public/runtime/admin/',0777);
