...
class TripInvoiceDetail extends LifeBaseAction {
    ...
    public function init() {
        ...
        $this->form->rules = array(
            ...
            'invoiceId' => array('filter' => 'required', 'message' => 'invoiceId is required'),
        );
    ...
    public function invoke() {
        try {
            ...
            $response = $obj->getInvoiceDetail($userInfo['id'], $data['invoiceId']);
