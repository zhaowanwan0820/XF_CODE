...
class ApplyTrans extends DuotouBaseAction {
    ...
    public function invoke() {
        ...
        $redeemTotalRemainMoney = \SiteApp::init()->dataCache->call($rpc, 'go', array('NCFGroup\Duotou\Services\RedemptionApply','getRedeemTotalRemainMoney',$request), 60);
        //$redeemTotalRemainMoney = $rpc->go('NCFGroup\Duotou\Services\RedemptionApply','getRedeemTotalRemainMoney',$request);
        $vars = array('id' => $dealLoanId,);
        $request->setVars($vars);
