...
class ReserveRule extends ReserveBaseAction {
    ...
    public function invoke() {
        ...
        $confType = ReservationConfModel::TYPE_NOTICE;
        $reserveNotice = $reservationConfService->getReserveInfoByType($confType);
        $this->tpl->assign('reserve_rule', (!empty($reserveNotice['reserve_rule']) ? htmlspecialchars_decode($reserveNotice['reserve_rule']) : ''));
        return true;
    }
}
