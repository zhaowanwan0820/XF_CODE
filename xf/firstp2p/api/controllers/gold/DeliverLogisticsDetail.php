...
class DeliverLogisticsDetail extends GoldBaseAction {
    ...
    public function invoke() {
        ...
        $res = $this->rpc->local('GoldService\deliverLogistics', array($user['id'],$orderId));
        ...
        header("Location:".$res['data']['data']['url']);
        exit;
    }
