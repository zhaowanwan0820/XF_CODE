...
class Error {
    ...
    public static function getCode($key) {
        return isset(self::$_err_arr[$key]) ? self::$_err_arr[$key]['errno'] : self::$_err_arr['ERR_SYSTEM']['errno'];
    }
    ...
    public static function getMsg($key) {
        return isset(self::$_err_arr[$key]) ? self::$_err_arr[$key]['errmsg'] : self::$_err_arr['ERR_SYSTEM']['errmsg'];
    }
    ...
    private static $_err_arr = array(
        ...
        'ERR_USER_THIRD_ASSET' => array("errno" => 21010, "errmsg" => "用户无该第三方资产"),
        // 22开头代表coupon相关
        ...
        'ERR_USER_KICKED' => array("errno" => 40005, "errmsg" => "您的账号已经在别的设备登录，请重新登录"),
        ...
        'ERR_BIGCHARGE_CLOSE' => array('errno' => 50003, 'errmsg' => '大额充值通道维护中，暂不能充值'),
        'ERR_BIGCHARGE_NOTLIST' => array('errno' => 50004, 'errmsg' => '您绑定的银行卡暂不支持大额充值，请登录网信电脑端进行网银充值'),
        ...
        //分站相关
        'ERR_THIRD_STATUS_DOWN' => array('errno'=>110001, 'errmsg' => '分站下架'),
        'ERR_THIRD_DOMAIN_NOT' => array('errno'=>110002, 'errmsg' => '分站域名不存在'),
        'ERR_THIRD_INFO_NOT' => array('errno'=>110003, 'errmsg' => '分站信息不存在'),
        'ERR_THIRD_CONF_NOT' => array('errno'=>110004, 'errmsg' => '分站配置不存在'),
