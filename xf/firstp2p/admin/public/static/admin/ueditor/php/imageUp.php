<?php
	...
	defined('APP_ROOT_PATH') or define('APP_ROOT_PATH', $dir_arr[0]);
	// defined('STATIC_UPLOAD_HOST') or define('STATIC_UPLOAD_HOST', $env_conf['STATIC_UPLOAD_HOST']);
	...
	$_conf = include_once($dir_arr[0]."/conf/common.conf.php");
	$GLOBALS['sys_config'] = array();
	$GLOBALS['sys_config']['vfs_ftp'] = $_conf['vfs_ftp'];
...
//        "savePath" => $imgSavePathConfig,
     ...
     * }
     */
    // $arr_url = explode("attachment",$info["url"]);
    //echo "{'url':'" . $upload_url.$arr_url[1] . "','title':'" . $title . "','original':'" . $info["originalName"] . "','state':'" . $info["state"] . "'}";
