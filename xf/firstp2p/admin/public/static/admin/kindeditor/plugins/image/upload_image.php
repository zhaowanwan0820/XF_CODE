	...
	<body>
		<div class="main">
			...
			<form name="uploadForm" method="post" enctype="multipart/form-data" target="uploadIframe" action="<?php echo $_REQUEST['root'];?>">
				...
				<input type="hidden" name="ctl" value="upload" />
				<input type="hidden" name="limit" value="<?php echo $_REQUEST['limit'];?>" />
				<input type="hidden" name="act" value="do_upload_img" />
				<ul class="table">
					<li>
						<div id="tab1" style="display:none;">
							<label for="url">图片地址</label>
							<input type="text" id="url" name="url" value="<?php echo $file_url;?>" maxlength="255" style="width:250px;" readonly onfocus='this.select()' />
							<input type="" id="viewServer" name="viewServer" value="" style="display:none;" />
						</div>
