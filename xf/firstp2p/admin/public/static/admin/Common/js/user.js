...
function user_passport_passed(user_id)
{
    $.ajax({
        ...
        success: function(data){
            ...
            html += '通行证正面:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
            ...
            html += '通行证反面:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
            ...
            html += '身份证正面:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
            ...
            html += '身份证反面:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if (data.passport.type == 2) {
                ...
                html += '护照个人信息页正面:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.idno1 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.idno1 + '" border="0" width="370"></a>';
                html += '本人手持护照正面照片:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.idno2 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.idno2 + '" border="0" width="370"></a>';
                html += '签证照片:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.pass1 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.pass1 + '" border="0" width="370"></a>';
                html += '盖有入境章的护照页:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.pass2 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.pass2 + '" border="0" width="370"></a>';
                ...
                html += '<a class="img" href="' + data.passport.file.pass2 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.idno2 + '" border="0" width="370"></a>';
                html += '军官证内页:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.idno1 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.pass1 + '" border="0" width="370"></a>';
                html += '手持证件照片:&nbsp;<a href="javascript:void(0)" class="_js_trans_pic" >反转</a>&nbsp;<a href="javascript:void(0)" class="_js_show_pic" >查证</a><br>';
                html += '<a class="img" href="' + data.passport.file.idno2 + '" target="_blank" style="display:none;">';
                html += '<img src="' + data.passport.file.pass2 + '" border="0" width="370"></a>';
            }else {
            }
