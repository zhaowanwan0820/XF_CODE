...
if(!defined('RUNTIME_PATH')) define('RUNTIME_PATH',APP_PATH.'/../runtime/admin/');
if(defined('RUNTIME_ALLINONE') && is_file(RUNTIME_PATH.'~allinone.php')) {
    ...
    if(!defined('ADMIN_APP_NAME')) define('ADMIN_APP_NAME', basename(dirname($_SERVER['SCRIPT_FILENAME'])));
