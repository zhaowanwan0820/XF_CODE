...
class PaymentAction extends CommonAction{
    ...
    public function insert()
    {
        ...
        if(is_numeric($_REQUEST['max_fee']))
            $data['max_fee'] = $_REQUEST['max_fee'];
     ...
     * 未完成大额充值订单入口
     */
    public function view_incomplete_large_charge()
    {
        ...
        $params = ['queryStatus'=>'I', 'userId'=>$userId];
        $result = $paymentService->offlineChargeOrderPage($params, 'PC', 'N');
