...
class voteModule extends SiteBaseModule
{
	public function index()
	{
		...
		{			 
			...
			{
				return showErr($GLOBALS['lang']['NO_VOTE'],0,APP_ROOT);
			}
		}
	...
	public function dovote()
	{
		...
		if(!$ok)
		{
			return showErr($GLOBALS['lang']['YOU_DONT_CHOICE']);
		}
		...
		if(check_ipop_limit(get_client_ip(),"vote",3600,$vote_id))
		{
			...
			return showSuccess($GLOBALS['lang']['VOTE_SUCCESS']);
		}
		else
		{
			return showErr($GLOBALS['lang']['YOU_VOTED']);
		}
	}
}
?>
