<?php
FP::import("app.deal");
class huiyingModule extends SiteBaseModule
{
	/**
	 * 预约信息
	...
	public function index(){
		...
		//return app_redirect(url('huodong-huiying'));
		//exit();
		...
		$GLOBALS['tmpl']->assign("page_title", "汇赢1号2期");
		$GLOBALS['tmpl']->display("huiying.html");
  ...
  public function full() {
  	$GLOBALS['tmpl']->assign("in_preset_page",1);
  	$GLOBALS['tmpl']->assign("page_title", "汇赢1号");
  	$GLOBALS['tmpl']->display("huiying-full.html");
  }
