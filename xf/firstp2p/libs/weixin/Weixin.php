 ...
 *               $weObj->text("hello, I'm Weixin")->reply();
 *               exit;
 *               break;
...
class Weixin
{
    ...
    const ACCESS_TOKEN_REDIS_CACHE_KEY_PREFIX = 'WEIXIN_ACCESS_TOKEN_CACHE';
    const JSAPI_TICKET_REDIS_CACHE_KEY_PREFIX = 'WEIXIN_JSAPI_TICKET_CACHE';
...
<Nonce><![CDATA[%s]]></Nonce>
    ...
    public function checkAuth($appid='',$appsecret='',$token=''){
        ...
        $this->access_token = unserialize($this->redis->get(self::ACCESS_TOKEN_REDIS_CACHE_KEY_PREFIX . $appid));
        ...
        if ($result)
        {
            ...
            $this->redis->set(self::ACCESS_TOKEN_REDIS_CACHE_KEY_PREFIX . $appid, serialize($this->access_token), 'ex', $expire);
            return $this->access_token;
        }
        return false;
    }
    ...
    public function getJsTicket($appid='',$jsapi_ticket=''){
        ...
        $this->jsapi_ticket = unserialize($this->redis->get(self::JSAPI_TICKET_REDIS_CACHE_KEY_PREFIX . $appid));
        ...
        if ($result)
        {
            ...
            $this->redis->set(self::JSAPI_TICKET_REDIS_CACHE_KEY_PREFIX . $appid, serialize($this->jsapi_ticket), 'ex', $expire);
            return $this->jsapi_ticket;
        }
        return false;
    }
