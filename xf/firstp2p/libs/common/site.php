...
class SiteApp
{
    ...
    private function setChannel()
    {
        ...
        if ($channel) {
            setcookie(\core\service\CouponService::LINK_COUPON_KEY, $channel, 0, '/', $rootDomain);
    ...
    {
        // add by wangyiming 20140325 JIRA#476
        $is_under_repair = app_conf('IS_UNDER_REPAIR');
        if ($is_under_repair == 1 && strpos($_SERVER['HTTP_HOST'], "admin")===false) {
