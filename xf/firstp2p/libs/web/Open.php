...
class Open {
    ...
    public static function getTemplateEngine() {
        if (!defined('APP') || APP != 'web') {
            ...
            $engine = app_conf('FENZHAN_OPEN_SWITCH') && !in_array(get_host(false), $GLOBALS['sys_config']['FENZHAN_NOT_OPEN']) ? new \AppTemplateV3() : new \AppTemplate();
        }
