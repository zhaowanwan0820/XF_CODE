...
class MongoDB
{
    ...
    */
    ...
    {
        $log_info = array(__CLASS__, __FUNCTION__, APP, $command, json_encode($arguments));
        try {
            $this->_connected || $this->connect();
        ...
        return $r;
            ...
            \libs\utils\Alarm::push('mongo', 'Mongo Exception', $e->getMessage());
            return false;
        }
    }
    ...
    public static function config($config_block)
    {
        ...
        if (isset($GLOBALS['components_config']['mongo'][$config_block])) {
            return $GLOBALS['components_config']['mongo'][$config_block];
        }
