...
class Commissions extends BaseAction {
    ...
    public function invoke() {
        ...
        $request = new RequestCommissions();
        ...
        foreach ($protos as $proto) {
            ...
            $tmp['beenSettled'] = $proto->getBeenSettled();
            $tmp['tobeSettled'] = $proto->getTobeSettled();
            $commissions[] = $tmp;
        }
        ...
        $data['hasBenefit'] = $response->getBeenSettled();
        $data['havingBenefit'] = $response->getTobeSettled();
