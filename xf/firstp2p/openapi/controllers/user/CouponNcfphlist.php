...
class CouponNcfphlist extends AdminProxyBaseAction {
    ...
    public function invoke() {
        ...
        foreach($list as $key => $value){
            ...
            $list[$key]['pay_time'] = ($list[$key]['pay_time'] > 0) ? date('Y-m-d H:i:s', $value['pay_time'] + self::TIMEDIFF) : 0;
        }

        $this->json_data = array(
            'list' => $this->getValueFromStyle($list, ['consume_user_name','consume_real_name','refer_real_name','agency_user_name']),
