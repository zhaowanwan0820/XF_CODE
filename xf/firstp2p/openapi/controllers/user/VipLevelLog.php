...
class VipLevelLog extends AdminProxyBaseAction {
    ...
    public function invoke() {
        ...
        foreach ($result['list'] as $item) {
            $return['dataList'][] = [
                ...
                'mobile'           => $item['mobile'],
                'serviceGradeDesc' => $item['service_grade_desc'],
                'actualGradeDesc'  => $item['actual_grade_desc'],
                'point'            => $item['point'],
                'logTypeDesc'      => $item['log_type_desc']
            ];
        }
