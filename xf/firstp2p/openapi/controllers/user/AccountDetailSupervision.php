...
class AccountDetailSupervision extends AdminProxyBaseAction {
    ...
    public function invoke() {
        ...
        $response = $this->revokeAdmin(array('id' => $id, 'page' => $params['page_num'], 'isNeedTotal' => 1));
        ...
        //分页
        $pageRow = intval($response['pageRow']);
        $totalRows = intval($response['totalRows']);
        $totalPages = intval($totalRows / $pageRow);
