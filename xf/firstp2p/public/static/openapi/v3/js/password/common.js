...
P2PWAP.ui.ErrorToaster_.prototype.createDom = function() {
    ...
    this.ele.setAttribute("style", "z-index:999;position:fixed;width:100%;text-align:center;bottom:15%;-webkit-transition:opacity linear 0.5s;opacity:0;");
...
P2PWAP.util.checkIdno = function(val) {
    return /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[A-Z])$/.test(val);
};

P2PWAP.util.checkIdno2 = function(val) {
    return /^[0-9A-Z()]{6,20}$/.test(val);
};
