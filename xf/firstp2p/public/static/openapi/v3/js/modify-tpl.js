...
$(function(){
    ...
    // $pageMain.prepend('<div class="tc pt10 f14 gray">请绑定持卡人本人的借记卡(需开通网银)</div>');
    // $pageTitle.after('<div class="login_banner"><img src="/static/v3/images/upload/bank_banner.png" width="100%"></div>');
    $submitBtnBox.after('<p class="tc pt10 f14">同意<a style="color:#ee4634;" href="https://m.ucfpay.com/mobilepay-p2p/zjtgProtocol.html">《先锋支付托管账户服务协议》</a></p>');
    if (!isWapApp) {
        $('.p_account_addbank_panel .JS-title').after('<div class="bank_tip">您可以通过<a href="http://www.wangxinlicai.com/app">下载网信理财客户端</a>或登录电脑选择其他银行。</div>');
