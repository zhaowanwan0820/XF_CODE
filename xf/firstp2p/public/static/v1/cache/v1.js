...
X.V = {
    ...
    checkCrash : function(field, rules, i, options){
         ...
         if (!regexp.test(fieldValue1) || fieldValue1 == '0') {
             return "请输入有效的数字金额";
         }
    },
    //测试金额的整数倍
	...
	var weebox = function(content, options) {
		...
		this.initBox = function() {
			...
			if (self.options.type == 'wee') {
				...
				'              		<a  class="btn-base dialog-ok"><span>确定</span></a>' +
                '    				<a  class="btn-base dialog-cancel" style="display: inline-block;"><span>取消</span></a>'  +
				'				</div>' +
				'			</td>' +
				...
				html = "<div class='dialog-box'>" +
							...
							"<div class='dialog-button'>" +
								...
								// "<input type='button' class='dialog-cancel' value='取消'>" +
								"<a  class='btn-base dialog-ok'><span>确定</span></a>" +
                  			    "<a  class='btn-base dialog-cancel'><span>取消</span></a>" +
							"</div>" +
						"</div>";
			}
