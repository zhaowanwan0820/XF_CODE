    ...
    $(function() {
        ...
        function ownHtml(data,status) {
            ...
            if(status==1){
                ...
                if(data.list.length<=0){
                    ...
                    for (var i = 0; i < data.list.length; i++) {
                        html += '<tr>';
                        html += '<td style="padding-left:10px;" width="83"><span class="color-yellow1">￥' + data.list[i].money + '</span></td>';
                        ...
                        html += '<td width="147" style="padding-right:10px;">' + data.list[i].from_type + '</td>';
                        html += '</tr>';
                    }
            ...
            if(status==2){
                ...
                if(data.list.length<=0){
                    ...
                    for (var i = 0; i < data.list.length; i++) {
                        html += '<tr>';
                        html += '<td style="padding-left:10px;" width="93"><span class="color-yellow1" >￥' + data.list[i].money + '</span></td>';
            ...
            if(status==3){
                ...
                if(data.list.length<=0){
                    ...
                    for (var i = 0; i < data.list.length; i++) {
                        html += '<tr>';
                        html += '<td width="93" style="padding-left:10px;">￥' + data.list[i].money + '</td>';
                        html += '<td width="98">' + data.list[i].bonus_type + '</td>';
                        html += '<td width="116">' + data.list[i].bid_limit + '</td>';
        ...
        function sendHtml(data) {
            ...
            if(data.list.length<=0){
                ...
                for (var i = 0; i < data.list.length; i++) {
                    html += '<tr>';
                    html += '<td class="text-left;">' + data.list[i].bonus_from + '<br />'+ data.list[i].bonus_name +'</td>';
