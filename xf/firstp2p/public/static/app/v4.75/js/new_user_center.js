$(function() {
    zhuge.track('进入新手专区页面')
    $('.go_register').click(function() {
        zhuge.track('新手专区_点击立即领取')
    });
    ...
    (function() {
        ...
        $('.deal_reserve_li .link').each(function(index, item) {
            var url = domainVal + '/duotou/DealDetail?is_allow_access=1&is_detail=1&activity_id=' + $(this).data('id') + '&site_id=' + window["site_id"]
            $(this).attr('href', schemePrefix + encodeURIComponent(url))
            $(this).siblings('.info').find('#right_now .MD_count_bid_now').attr("href", schemePrefix + encodeURIComponent(url))
        })
    })();
    ...
    if (isRegister != 1) {
        ...
        $(".newcomer .copyright").addClass("copyright_1")
    }
})