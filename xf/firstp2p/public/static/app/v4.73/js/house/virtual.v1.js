(function() {
    ...
    var virtualKey = function(element, opts) {
        ...
        _this.keyboardhide();
        _this.kbAddvalue();
        $("body").on("touchend", ".key_bg" ,function() {
            _this.keyboardhide();
        });
    };
    ...
    virtualKey.prototype = {
        ...
        init: function() {
            ...
            keyhtml += "  <li data-key=0 class=\"key_zero\"><span>0</span></li>";
            keyhtml += "</ul>";
        ...
        kbAddvalue: function() {
            ...
            var $key_ul = $(".key_ul"),
                keyboard_key;
            var decimalNum=this.options.decimalNum;
            var checkValReg=new RegExp('^(0|[^0]\\d{0,3})(\\.\\d{1,'+decimalNum+'})?$');
            ...
            $key_ul.find("ul>li").bind("touchend", function() {
                ...
                if (keyboard_key == "del") {
                    ...
                    if (checkValReg.test(newvalue + sval)) {
                        newvalue += sval;
                    }
                    $thisinput.html(newvalue);
                    _this.options.changeFn();
