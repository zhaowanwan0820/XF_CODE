...
P2PWAP.ui.ErrorToaster_.prototype.createDom = function() {
    ...
    this.ele.setAttribute("style", "z-index:999;position:fixed;width:100%;text-align:center;top:50%;margin-top:-55px;-webkit-transition:opacity linear 0.5s;opacity:0;");
...
P2PWAP.util.request = function(requrl, success_callback, errorCallback, opt_method, opt_data) {
    var senddata = (typeof opt_data != 'undefined') ? opt_data : {};
    ...
    return $.ajax({
        ...
        success: function(json) {
            if (json['errno'] === 0) {
                success_callback.call(null, json);
            }else{
                errorCallback.call(null, json);
            }
...
P2PWAP.util.getWapHost = function(param, reg, idx){
    var _redirectUri, _matchResult, _wapHost = 'm.wangxinlicai.com';
    ...
    if (_matchResult) {
        _wapHost = _matchResult[idx] ? _matchResult[idx] : 'm.wangxinlicai.com';
    }
    return _wapHost;
};
