...
(function($) {
	...
	var weebox = function(content, options) {
		...
		this.bwidth = function() {
			if ($.support.leadingWhitespace && $.browser.version < 7) {
...
$.showSuccess = function(str,func,title)
{
	$.weeboxs.open(str, {boxid:'fanwe_success_box',contentType:'text',showButton:true, showCancel:false, showOk:true,title:title,width:250,type:'wee',onclose:func});
};