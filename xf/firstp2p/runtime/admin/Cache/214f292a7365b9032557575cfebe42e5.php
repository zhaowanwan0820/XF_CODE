...
<script type="text/javascript">
    ...
    var referUrl = '<?php echo $_GET['refer']; ?>';
...
<table border="0" cellpadding="0" cellspacing="0" width="695" style="margin:0px auto;">
  ...
  <tr>
   ...
   <td rowspan="11"><img name="login_r2_c2" <?php if(!$isOrg): ?>src="__TMPL__Common/images/login/login_r2_c2.png"<?php else: ?>src="__TMPL__Common/images/login/login_org.png"<?php endif; ?> width="300" height="229" border="0" id="logo" alt="" /></td>
  ...
  <tr>
   ...
   <?php if($isAdminVerify): ?><input type="text" style="border:0px; width:92px; height:15px; padding:5px; font-size:12px; background:none;" class="login_input adm_verify" name="adm_verify"  />
   <?php else: ?>
   <input type="text" style="border:0px; width:92px; height:15px; padding:5px; font-size:12px; background:none;" class="login_input adm_verify" name="adm_verify" value="****" readonly/><?php endif; ?>
   </td>
