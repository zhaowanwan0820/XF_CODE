...
<FRAMESET FRAMEBORDER=10 framespacing=0 border=0 rows="106, *,32">
...
<FRAMESET FRAMEBORDER=0  framespacing=0 border=0 cols="200,7, *" id="frame-body">
	...
	<FRAME SRC="<?php echo u('Index/welcome');?>" FRAMEBORDER=0 id="main-frame" name="main">
</FRAMESET>
<FRAME SRC="<?php echo u('Index/footer');?>" name="footer" FRAMEBORDER=0 NORESIZE SCROLLING='no' marginwidth=0 marginheight=0>i
