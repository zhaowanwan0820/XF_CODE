...
<script type="text/javascript">
    ...
    {
        var bankEditAction = "editBankAccount";
        var btnCtlId = "#updateButtonId";
        if (type == 2) {
            bankEditAction = "editSupervisionBankAccount";
            btnCtlId = "#updateSupervisionButtonId";
        }
        ...
        */
        ...
        if (confirm("您确定要更新银行账户信息吗？")) {
            $(btnCtlId).css({"color":"gray","background":"#ccc"}).attr("disabled","disabled");
            var s_name = $("#s_name").val();
            var bankzone_value2 = parseInt($("#bankzone_value2").val());
            //通知支付部门进行开户
            $.post("/m.php?m=Enterprise&a="+bankEditAction, {
                'id':$("#bank_auto_id").val(),
...
//                var rsobj = eval( "(" + rs +  ")");
            ...
            $(btnCtlId).css({ "color": "#fff", "background-color": "#4E6A81" }).removeAttr("disabled");
            return true;
        }
        return false;
    }
...
<table class="form" cellpadding=0 cellspacing=0>
    ...
    <tr>
        ...
        <td class="item_input">
            <input type="hidden" id="bank_auto_id" name="bank_auto_id" value="<?php echo ($bankcardInfo["id"]); ?>">
            <input type="hidden" id="bank_user_id" name="bank_user_id" value="<?php echo ($userId); ?>">
            <input type="hidden" id="s_name" name="s_name" value="<?php echo ($s); ?>">
            <input type="text" id="card_name2" name="card_name2" class="textbox _js_bankinfo require" value="<?php echo ($bankcardInfo["card_name"]); ?>" /><font color='red'>*</font>
        </td>
    </tr>
    <tr>
        <td class="item_title">银行帐号:</td>
        <td class="item_input">
            <input type="text" id="bankcard2" name="bankcard2" class="textbox _js_bankinfo require" value="<?php echo ($bankcardInfo["bankcard"]); ?>" onkeyup="value=value.replace(/[^\d\.]/g,'')" style="ime-mode:Disabled" maxlength="32" /><font color='red'>*</font>
        </td>
    </tr>
    <tr>
        ...
        <td class="item_input">
            <select id="card_type" name="card_type" class="_js_bankinfo textbox require" style="width:180px;">
                <option value="1" <?php if($bankcardInfo['card_type'] == '' OR $bankcardInfo['card_type'] == 1): ?>selected="selected"<?php endif; ?>>公司账户</option>
                <option value="0" <?php if($bankcardInfo['card_type'] != '' AND $bankcardInfo['card_type'] == 0): ?>selected="selected"<?php endif; ?>>个人账户</option>
            </select>
            <font color='red'>*</font>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="item_input">
            <input type="text" id="bank_shortno2" name="bank_shortno2" class="textbox _js_bankinfo require" value="<?php echo ($bank_short_name); ?>" readonly="readonly" /><font color='red'>*</font>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="item_input">
                <input type="hidden" id="bank_region_input2_lv1" name="bank_region_input_lv1" value="<?php echo ($bankcardInfo["region_lv1"]); ?>">
                <input type="hidden" id="bank_region_input2_lv2" name="bank_region_input_lv2" value="<?php echo ($bankcardInfo["region_lv2"]); ?>">
                <input type="hidden" id="bank_region_input2_lv3" name="bank_region_input_lv3" value="<?php echo ($bankcardInfo["region_lv3"]); ?>">
                <input type="hidden" id="bank_region_input2_lv4" name="bank_region_input_lv4" value="<?php echo ($bankcardInfo["region_lv4"]); ?>">
    ...
    <script type="text/javascript">
         ...
         function bank_site_bank2(){
           ...
           var n = encodeURIComponent('<?php echo ($bankcardInfo["bankzone"]); ?>');
         ...
         function reset_bank_window(){
             //$.weeboxs.close();
             //$.weeboxs.open(ROOT+'?m=Enterprise&a=editBankAccount&uid=<?php echo ($userId); ?>', {contentType:'ajax',showButton:false,title:'编辑银行账户',modal:true,overlay:5,width:600,height:500,onopen: function(){}});
    ...
    <tr>
        ...
        <td id="_js_bank_site_tips">
            <select data-placeholder="请选择开户网点" id="_js_bankone2" name="bank_bankzone2" class="_js_bankinfo textbox require" style="width:350px;">
              <option value="0">=请选择=</option></select><font color='red'>*</font>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="item_input">
            <input type="hidden" id="bankzone_value2" name="bankzone_value2" value="<?php echo ($bankcardInfo["status"]); ?>" />
    ...
    <tr>
        ...
        <td class="item_input">
            ...
            <input type="hidden" id="moduleName" name="<?php echo conf("VAR_MODULE");?>" value="Enterprise" />
            <input type="hidden" id="actionName" name="<?php echo conf("VAR_ACTION");?>" value="editBankAccount" />
            <!--隐藏元素-->
            <input type="button" id="updateButtonIdSupervision" class="button" value="只更本地和存管" onclick='return checkInchargeForm(2);'/>
            <input type="button" id="updateButtonId" class="button" value="保存" onclick='return checkInchargeForm(1);'/>
            <input type="reset" class="button" value="<?php echo L("RESET");?>" onclick='reset_bank_window();' />
        </td>
    </tr>
    <tr>
