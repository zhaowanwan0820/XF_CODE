...
if ($p2pRc)
{
    $notifyDomain = $http.'prenotify.ncfwx.com';
    $phNotifyDomain = $http.'prenotify.firstp2p.cn';
} else {
    $notifyDomain = $http.'notify.ncfwx.com';
    $phNotifyDomain = $http.'notify.firstp2p.cn';
}
$env_conf = array(
    // 通知域名
    'NOTIFY_DOMAIN' => $notifyDomain,
    'PH_NOTIFY_DOMAIN' => $phNotifyDomain,
 ...
 //       'yingshi.firstp2p.com',
    ...
    'XINDAI_DOMAIN' => "http://ncfcredit-cssincerity-api.corp.ncfgroup.com",
    'XINDAI_SALT' => 'fgrqewhafu8c03u4ea4',

    //网信普惠wap站
    'NCFPH_WAP_HOST'     => 'https://m.firstp2p.cn',
    'NCFPH_API_SERVER_URL'  => "http://api.firstp2p.cn",

    //英文en站
    'NCF_EN'  => "https://en.ncfwx.com",

    //英文跳转到CH站
    'NCF_CH'  => "https://www.ncfwx.com",

    //英文ir站
    'NCF_EN_IR'  => "https://ir.ncfwx.com",

    'API_HOST' => "https://api.ncfwx.com",

    // 电销中心接口ip
    'API_CALL_CENTER' => 'http://cc.ncfwx.com',
    // 游戏Sparow接口
    'SPAROW_API' => 'https://game.ncfwx.com/api',
    'SPAROW_FROM' => 'ncfwx',
 ...
 */
    ...
    'STATIC_FILE_VERSION'    => 'v1',
     ...
     //信仔智能推荐获取权值接口
    'API_XINZAIZHINENG_QUANZHI' => 'http://lark.corp.ncfgroup.com/api/bzquery/user_deal_recommend',
    ...
    'OAUTH_SERVER_CONF' => array(
        ...
        //工单
        '03de4286d417d3d330b26ee5271ecd40' => array(
            'client_id' => '03de4286d417d3d330b26ee5271ecd40',
        ...
        '1a4fab3bd9633fa08ef91830' => array(
                ...
                'redirect_uri' => 'https://lcs.wangxinlicai.com/oauth/LoginBack'
            ),
        ...
        //ncfwx 后台域名
        'NCFWX_ADMIN_DOMAIN' => "admin.firstp2p.com",
        //o2o 后台域名
        'O2O_ADMIN_DOMAIN' => "o2o.firstp2padmin.corp.ncfgroup.com",
        //ncfph 后台域名
        'NCFPH_ADMIN_DOMAIN' => "admin.firstp2p.cn/m.php?m=UserBridge&a=auth",
        'MEDAL_ADMIN_DOMAIN' => "admin.medal.corp.ncfgroup.com",
        //open 开放平台后台域名
        'OPEN_ADMIN_DOMAIN' => "open.firstp2padmin.corp.ncfgroup.com",
        //markting 后台域名
        'MARKETING_ADMIN_DOMAIN' => "marketing.firstp2padmin.corp.ncfgroup.com",
        //理财师后台域名
        'LCS_ADMIN_DOMAIN' => "lcs.wangxinlicai.com",
    //gold 后台域名

    'GOLD_ADMIN_DOMAIN' => "gold.firstp2padmin.corp.ncfgroup.com", // 生产环境黄金后台桥接
    'GOLD_ADMIN_DOMAIN_PRE' => "pregold.firstp2padmin.corp.ncfgroup.com", // 灰度环境黄金后台桥接
