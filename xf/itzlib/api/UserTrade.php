<?php
class UserTrade extends ItzApi{
    ...
    public function logTypes($type){
        switch ($type) {
            ...
            case 'capital':     $logtypes = $this->typeNames['capital']; break;
    ...
    public function queryLogs($userid,$page,$type,$start_time,$end_time){
        ...
        $sumMoney = '';
        if(in_array($type, array('recharge','cash','invest','interest','capital','interest_reward'))){
