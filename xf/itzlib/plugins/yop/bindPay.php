	...
	<body>
		<table width="50%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px #107929">
		  ...
		  <tr>
			...
			<form method="post" action="sendBindPay.php" targe="_blank">
		  <tr>
	   ...
	   <tr>
		  	<td align="left">&nbsp;&nbsp;卡号前六位</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="cardtop" id="cardtop"  value=""/> 
		  	 		&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td>
      </tr>
		  <tr>
		  	<td align="left">&nbsp;&nbsp;卡号后四位</td>
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="cardlast" id="cardlast"  value=""/>
      	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
       ...
       <tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="advicesmstype" id="advicesmstype"  value="MESSAGE"/></td>
      </tr>
	  <tr>
	    ...
	    <tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<input size="50" type="text" name="productname" id="productname"  value="测试产品"/> 
		  		&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
	   <tr>
	   ...
	   <tr>
     	...
     	&nbsp;<span style="color:#FF0000;font-weight:100;">*</span></td></tr>
		    ...
		    <tr>
		  	...
		  	<td align="left">&nbsp;&nbsp;<textarea id="dividejstr" style="width: 67%;" name="dividejstr" rows="5"  >[{"ledgerno":"10000449592","dividemode":"PERCENT","dividevalue":"0.25"}]</textarea> </td>
      </tr>
		  <tr>
		  	<td align="left">&nbsp;</td>
