...
function divideRecord(){
    ...
    $response = YopClient3::post("/rest/v1.0/paperorder/account-checkfacade/api-divide-check-account", $request);
 ...
 $result= $array['result'] ;
     ...
     $path='/var/www/html/demo/sqkk-zd/divideRecord/'.date("Y-m-d");  //配置文件夹绝对路径，以日期为文件夹名称
