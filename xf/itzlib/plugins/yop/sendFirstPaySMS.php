...
function firstPaySMS(){
    ...
    $response = YopClient3::post("/rest/v1.0/paperorder/firstpayorder/resend", $request);
...
<title> 首次支付短验重发返回参数</title>
	...
	<body>	
		...
		<table width="70%" border="0" align="center" cellpadding="5" cellspacing="0" style="border:solid 1px #107929">
			...
			<tr>
				<td width="25%" align="left">&nbsp;充值请求号</td>
				<td width="5%"  align="center"> : </td> 
			...
			<tr>
				...
				<td width="30%" align="left">status</td> 
			 	...
			 	<tr>
				<td width="25%" align="left">&nbsp;短信验证码</td>
				<td width="5%"  align="center"> : </td> 
