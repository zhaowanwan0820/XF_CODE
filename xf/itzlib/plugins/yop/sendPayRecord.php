...
function payRecord(){
    ...
    $response = YopClient3::post("/rest/v1.0/paperorder/api/accountcheck/tempcardpay", $request);
 ...
 $result= $array['result'] ;
     ...
     $path='/var/www/html/demo/sqkk-zd/payRecord/'.date("Y-m-d");  //配置文件夹绝对路径，以日期为文件夹名称
