<?php
	...
	*/
	...
	//默认活动编号(cid)
	define("default_campaign_id", "17520");	
	
	//默认的目标地址(url)，一般默认的是首页
	define("default_target", "https://www.xxx.com/index.php?user&q=action/sem_reg&fr&src=ymcps");
	
	//cookie保存域(建议保存这样的域名：.yiqifa.com)
	define("union_cookie_domain",".xxx.com");
	...
	//cookie名字
	define("union_cookie_name","itouzi_ym_cps");
	...
	define("interId","5292b7649497a64046b5621c");
?>
