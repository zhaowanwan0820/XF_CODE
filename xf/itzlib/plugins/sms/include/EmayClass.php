...
include_once( dirname(__FILE__) .'./../nusoaplib/nusoap.php');
...
class EmayClass {
	 ...
	 * 
	 */
	function EmayClass($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
	{
		$this->url = $url;
	 ...
	 * @return int 操作结果状态码
	 */
	function sendSMS($mobiles=array(),$content='',$sendTime='',$addSerial='',$charset='GBK',$priority=5, $smsID='')
	{
