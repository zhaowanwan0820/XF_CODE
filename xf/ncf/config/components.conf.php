...
return array(
    'components' => array(
        ...
        'tagRedisCluster' => array(
            ...
            'nodes' => array(
                'tcp://redis4.ncfgroup.org:6381?timeout=1&persistent=1',
                'tcp://redis5.ncfgroup.org:6381?timeout=1&persistent=1',
                'tcp://redis6.ncfgroup.org:6381?timeout=1&persistent=1',
                'tcp://redis7.ncfgroup.org:6381?timeout=1&persistent=1',
                'tcp://redis8.ncfgroup.org:6381?timeout=1&persistent=1',
                'tcp://redis9.ncfgroup.org:6381?timeout=1&persistent=1',
            )
        ),
        // 邮件队列
        'prior_queue' => array(
