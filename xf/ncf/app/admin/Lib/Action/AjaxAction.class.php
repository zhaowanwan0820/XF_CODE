...
class AjaxAction extends CommonAction{
    ...
    */
    ...
    public function getLoanFee()
    {
        ...
        // 计算服务费
        if (in_array($loan_fee_rate_type, array(DealExtEnum::FEE_RATE_TYPE_FIXED_BEFORE, DealExtEnum::FEE_RATE_TYPE_FIXED_BEHIND, DealExtEnum::FEE_RATE_TYPE_FIXED_PERIOD))) {
