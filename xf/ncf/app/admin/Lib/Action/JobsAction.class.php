 ...
 * */
use core\service\jobs\JobsService;
...
class JobsAction extends CommonAction{
    ...
    public function fail() {
        $_GET['status'] = JobsEnum::JOBS_STATUS_FAILED;
        $this->index();
    }
    ...
    public function index() {
        ...
        $statusCn = JobsEnum::$statusCn[$map['status']];
        $GLOBALS['statusCn'] = JobsEnum::$statusCn;
    ...
    public function view() {
        ...
        $job['status'] = JobsEnum::$statusCn[$job['status']];
