...
class DiscountPickList extends BaseAction {
    ...
    public function invoke()
    {
        ...
        $type = array_key_exists($data['type'], DiscountService::$DISCOUNT_TYPES) ? $data['type'] : 0;
        ...
        $ret = DiscountService::getAvailableDiscountList($uid, $dealId, false, $page, self::PAGE_SIZE, $type, $consumeType);
        $list = $ret['list'] ?: [];
        $total = $ret['total'] ?: 0;
