...
class Lists extends BaseAction {
    ...
    public function invoke() {
        ...
        $response = \SiteApp::init()->dataCache->call(new DuotouService(), 'call', array(array('\NCFGroup\Duotou\Services\Project','listProjectFrontend',$request)), 30);
