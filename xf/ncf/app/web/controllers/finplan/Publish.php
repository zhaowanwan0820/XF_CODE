...
class Publish extends BaseAction {
    ...
    public function invoke() {
        ...
        $userId = $user['id'];
        $dtPublishService = new DtPublishService();
        $res = \SiteApp::init()->dataCache->call($dtPublishService, 'getPublishP2pDeals', array($userId,$pageNum,$pageSize), 30);
        $p2pDeals = $res['list'] ;
        $canCancel = $dtPublishService->getCanCancelToday($userId);
