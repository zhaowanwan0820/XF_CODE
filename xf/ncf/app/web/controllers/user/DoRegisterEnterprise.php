...
class DoRegisterEnterprise extends BaseAction {
    ...
    public function invoke() {
        ...
        $userInfo = array(
            ...
            'usertype' => UserEnum::USER_TYPE_ENTERPRISE,        // 企业用户类型
            'user_purpose' => UserAccountEnum::ACCOUNT_INVESTMENT   // 默认是企业投资户
        );
        ...
        $userInfo['user_purpose'] = UserAccountEnum::ACCOUNT_INVESTMENT; // 企业用户默认投资户
        ...
        if ($upResult['status'] < 0) {
            ...
            if ($isPermanent === 1) {
                $credentialsExpireAt = UserAccountEnum::$credentialsExpireAtDefault;
            } else {
            ...
            $enterpriseBaseData = [
                ...
                'company_purpose' => UserAccountEnum::ACCOUNT_INVESTMENT, // 企业用户默认投资户
                'user_id' => intval($upResult['user_id']),
                'credentials_type' => intval($this->form->data['credentials_type']),
                'credentials_expire_date' => addslashes($this->form->data['credentials_expire_date']),
                'credentials_expire_at' => $credentialsExpireAt,
    ...
    public function getShowTemplate() {
        return 'web/views/user/registercompany.html';
    }
