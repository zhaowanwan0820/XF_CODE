...
class Finplanshow extends BaseAction {
    ...
    public function invoke() {
        ...
        $response = DuotouService::callByObject(array('NCFGroup\Duotou\Services\DealLoan','getDealLoanByIdForShow',$request));
        if(!$response) {
        ...
        //$data['minTransferDays'] = intval($deal_load['projectInfo']['minTransferDays']);
        //$data['maxTransferDays'] = intval($deal_load['projectInfo']['maxTransferDays']);
