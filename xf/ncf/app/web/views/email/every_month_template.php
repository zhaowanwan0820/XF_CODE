...
<script src="<?php echo $asset->makeUrl("/v3/js/common/html5shiv.js?v={$version}",1);?>"></script>
<link href="<?php echo  $asset->makeUrl('/v3/css/ie6-fix.css?v='.$version,1); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo $asset->makeUrl('/v3/css/base.css?v='.$version,1);?>" rel="stylesheet" type="text/css">
<link href="<?php echo $asset->makeUrl('/v3/css/common.css?v='.$version,1); ?>" rel="stylesheet" type="text/css">
<link href="<?php echo $asset->makeUrl('/v3/css/p_email.css?v='.$version,1); ?>" rel="stylesheet" type="text/css">

<script type="text/javascript" src="<?php echo $asset->makeUrl('/v3/js/common/DD_belatedPNG.js?v='.$version,1); ?>"></script>
<script type="text/javascript" src="<?php echo $asset->makeUrl('/v3/js/common/DD_belated_ie6_fix.js?v='.$version,1); ?>"></script>
...
<div class="email_main" style="width:800px; border:1px solid #dedede; margin:0px auto; background:#fafafa; font-family:Microsoft YaHei">
    <div class="e_title" style="height:89px; text-align:center; border-bottom:3px solid #ff804d;">
        <img src="<?php echo $asset->makeUrl('/v3/images/email/title_bg_wx.png',1); ?>">
    </div>
            ...
            <thead style="background:#61b2e6; line-height:66px; font-size:28px;">
                <tr style="color:#848484;">
                    <td style="color:#fff;" height="50"><span style="padding-left:15px; font-size:28px;"><i class="icon_e_user" >
                        <img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v3/images/email/icon_02.png',1);?>">
...
if($arr[1] == 'hotmail.com') {
    ?>

                                <table border="0" cellspacing="0" cellpadding="0"  height="215" align="center">
                            <tr>
                                <td rowspan="3" style="width:20px; height:215px;font-size:0px; line-height:0px; padding-top:0px;"><img src="<?php echo $asset->makeUrl('/v3/images/email/icon_left.png',1); ?>" width="20" height="215"></td>
                                <td style="width:175px; height:72px; font-size:0px; line-height:0px;"><img src="<?php echo  $asset->makeUrl('/v3/images/email/icon_top.png',1); ?>" ></td>
                                <td rowspan="3" style="width:33px; height:215px; overflow:hiddenfont-size:0px; line-height:0px;"><img src="<?php echo $asset->makeUrl('/v3/images/email/icon_right.png',1);?>"></td>
                            </tr>
                             <tr>
                             ...
                             <tr>
                                <td style=" height:71px;font-size:0px; line-height:0px;"><img src="<?php echo $asset->makeUrl('/v3/images/email/icon_bottom.png',1);?>" ></td>
                                </tr>
                        </table>
...
?>
<div style="background:url(<?php echo $asset->makeUrl('/v3/images/email/icon_01.png',1);?>) no-repeat;width:230px; height:215px;display:block;color:#ff804d;text-align:center;position:relative;font-size: 24px;">
...
?>
                ...
                <tr style="background:#e7f5ff; color:#848484">
                    <td style="padding:0 0 10px 40px;font-family:Microsoft YaHei"><span style="font-size:18px;"><i class="icon_e_keyong" style="vertical-align:middle;">
                        <img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v3/images/email/icon_03.png',1);?>"></i><span style="padding-left: 10px;  height:40px; vertical-align:middle">可用余额：<?php echo format_price($user_info['money']);?></span></span></td>
                    <td style="padding:0 0 10px 0px;font-family:Microsoft YaHei"><span style="font-size:18px;"><i class="icon_e_benjin" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v3/images/email/icon_06.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">待收本金：<?php echo format_price($user_statics['principal'])?></span></span></td>
                </tr>
                <tr style="background:#e7f5ff; color:#848484">
                    <td  style="padding:0 0 10px 40px;font-family:Microsoft YaHei" ><div  style=" padding-bottom:20px;font-family:Microsoft YaHei"><span style="font-size:18px;font-family:Microsoft YaHei"><i class="icon_e_dongjie" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v3/images/email/icon_04.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">冻结金额：<?php echo format_price($user_info['lock_money']);?></span></span></div></td>
                    <td style="padding:0 0 10px 0px;font-family:Microsoft YaHei"><div  style=" padding-bottom:20px;"><span style="font-size:18px;"><i class="icon_e_daishou" style="vertical-align:middle;"><img style="vertical-align:middle;" src="<?php echo $asset->makeUrl('/v3/images/email/icon_05.png',1);?>"></i><span style="padding-left: 10px; height:40px; vertical-align:middle">待收收益：<?php echo format_price($user_statics['interest']);?></span></span></div></td>
                </tr>
            </tbody>
        </table>
        </div>
          ...
          <tr>
              <td align="center">
                  <a href="<?php echo $main_site;?>/" title="网信" style="width:150px; height:40px; display:block; border:0px; margin:30px auto 50px;">
                    <img src="<?php echo $asset->makeUrl('/v3/images/email/logo_wx.png?v=20150624',1); ?>" style="border:none 0px;"></a>
              </td>
          </tr>
        </table>
