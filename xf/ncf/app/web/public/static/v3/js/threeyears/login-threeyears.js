$(function(){
	...
	var sourceFiles = [
		{"url": "earth.png", "size": 42},
		{"url": "share.png", "size": 4.42},
		{"url": "icon-star.png", "size": 1.98},
		{"url": "icon-thanks.png", "size": 10.4},
		{"url": "moon.png", "size": 7.16},
		{"url": "people.png", "size": 4.69},
		{"url": "rocket.png", "size": 8.73},
		{"url": "rocket-bd.png", "size": 4.95},
		{"url": "rocket-ft.png", "size": 5.24},
		{"url": "sc-01.png", "size": 4.55},
		{"url": "statistics-1.png", "size": 17.2},
		{"url": "statistics-2.png", "size": 13.7},
		{"url": "statistics-3.png", "size": 17.7},
		{"url": "statistics-4.png", "size": 13.7},
		{"url": "statistics-5.png", "size": 19.3},
		{"url": "statistics-6.png", "size": 11.7},
		{"url": "statistics-7.png", "size": 15.9},
		{"url": "statistics-8.png", "size": 19.5},
		{"url": "statistics-galaxy.png", "size": 33.7}
	];
	...
	SectionAnimate.prototype = {
		...
		show : function(index){
			...
			if(!this.opt.isNewUser){  // 不显示个人信息
				if(this.index > 7 && this.index < 11){
					$('#btn-play').show();
				}else{
					$('#btn-play').hide();
				}
				if(this.index == 8 || this.index == 9 || this.index == 10){
	...
	function setMemberData(data){
		...
		for (var i = 0; i < dataElement.length; i++) {
			$(dataElement[i]).text(memberData[i]);
		}
	};
});
