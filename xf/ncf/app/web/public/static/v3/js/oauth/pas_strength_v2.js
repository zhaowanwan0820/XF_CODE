...
Pas_strength.prototype={
    ...
    pasPanel:function(pasStr){
        ...
        switch (this.pasLevel(pasStr)){
            case 0:{
                ...
                levelSpans.filter(':nth-child(1)').addClass('low');
                break;
            }
            case 1:{
                this.tipLevelFn(levelTextSpan,'中');
                levelSpans.filter(':nth-child(1)').addClass('low');
                levelSpans.filter(':nth-child(2)').addClass('middle');
                break;
            }
            case 2:{
                //debugger;
                ...
                levelSpans.filter(':nth-child(1)').addClass('low');
                levelSpans.filter(':nth-child(2)').addClass('middle');
                levelSpans.filter(':nth-child(3)').addClass('high');
                break;
            }
        }
    ...
    pasValid:function(pasStr){
        ...
        if(!!$("#old_password")[0] && $("#old_password").val() === pasStr){
            returnArr.push(4);
            flag=false;
        }
