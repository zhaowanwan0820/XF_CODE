...
class GetDealStatusByAppronum extends BaseAction
{
    ...
    public function invoke()
    {
        ...
        $dealDkService = new DealDkService();
        $dealDkStatus = $dealDkService->getDkStatusForStoreBusiness($params['approveNumber']);
        ...
        $dealStatus = (($ret['deal_status'] == DealEnum::DEAL_STATUS_REPAY) && ($ret['is_has_loans'] !=1)) ? DealEnum::DEAL_STATUS_FULL : $ret['deal_status'];
