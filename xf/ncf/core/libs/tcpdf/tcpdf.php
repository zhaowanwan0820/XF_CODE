...
// TCPDF configuration
define(__DIR__,APP_ROOT_PATH.'core/libs/tcpdf');
...
class TCPDF {
    ...
    protected function setPageFormat($format, $orientation='P') {
         $r = file_exists(__DIR__.'/tcpdf_autoconfig.php');

        \libs\utils\Logger::info(implode(" | ",array(__FILE__,__FUNCTION__,__LINE__,__DIR__,$r)));
    ...
    /**
     * ×¢ÊÍ´ËÐÐ ÒÑ±£Ö¤ÎÄ¼þÃû¿ÉÒÔÊ¹ÓÃÖÐÎÄ
