...
class YeepayPaymentService extends BaseService {
    ...
    private static $errorMap = array(
        'bindBankCard' => array( // 4.1.1 绑卡请求接口
            'TZ1001001' => '系统异常',
            'TZ1001004' => '系统短验异常',
            'TZ1001005' => '订单不存在',
            'TZ1001006' => '发送短信验证码频率过高',
            'TZ1001007' => '验证同一个短验次数超限，请重新获取新的短验',
            'TZ1001008' => '短信验证码有误',
            'TZ1001009' => '短验码已确认成功，无需重复确认',
            'TZ1001011' => '短信发送次数超限',
            'TZ1001012' => '短验码已经过期',
            ...
            'TZ1001035' => '银行卡被限制，详情请咨询发卡行',
            'TZ1001036' => '不支持此银行卡',
            'TZ1001037' => '该银行卡未开通银联在线支付业务',
            'TZ1001038' => '输入姓名有误',
            'TZ1001039' => '证件信息有误',
            'TZ1001040' => '卡信息有误',
            'TZ1001042' => '银行系统异常',
            ...
            'TZ1001049' => '入参不能为空',
            'TZ0400002' => '卡号输入错误',
            'default' => '身份证、姓名或银行预留手机号有误', // 默认提示
        ),
        'confirmBindBankCard' => array( // 4.1.2 确认绑卡接口
            'TZ1001001' => '系统异常',
            'TZ1001004' => '系统短验异常',
            'TZ1001005' => '订单不存在',
            'TZ1001006' => '发送短信验证码频率过高',
        ...
        'directBindPay' => array( // 4.3 支付接口-不发送短验-支付请求接口
            'TZ2010001' => 'CVN验证失败',
            'TZ2010002' => 'CVV2或有效期有误',
            'TZ2010003' => '本卡在该商户不允许此交易',
            'TZ2010004' => '参数异常',
            'TZ2010005' => '超过商户日交易笔数',
            'TZ2010006' => '超过商户日交易限额',
            'TZ2010007' => '超过商户月交易笔数',
            'TZ2010008' => '持卡人认证失败，请重新核对信息',
            'TZ2010009' => '冲正成功',
            'TZ2010010' => '冲正异常',
            'TZ2010011' => '单日消费次数超限',
            'TZ2010012' => '短信验证码错误',
            'TZ2010013' => '短信验证码发送次数超限',
            'TZ2010014' => '短信验证码发送失败',
            'TZ2010015' => '短信验证码过期',
            'TZ2010016' => '该订单不支持退款',
            'TZ2010017' => '该卡不支持无卡支付',
            ...
            'TZ2010030' => '请您确认身份证件号是否填写正确',
            'TZ2010031' => '请求正在处理中',
            'TZ2010032' => '商户单笔金额超限',
            'TZ2010033' => '商户月累计金额超限',
            'TZ2010034' => '身份证号必须为18位',
            'TZ2010035' => '身份证或姓名有误',
            'TZ2010036' => '身份证与姓名不匹配',
            'TZ2010037' => '手机号码无记录',
            'TZ2010038' => '手机号为空',
            ...
            'TZ2010045' => '无效卡号，请核对重新输入',
            'TZ2010046' => '系统异常',
            'TZ2010047' => '消费金额超限',
            'TZ2010048' => '姓名为空',
            'TZ2010049' => '需要手机短验',
            'TZ2010050' => '一分钟内同一手机号校验过频繁，请稍后再试',
            'TZ2010051' => '银行处理中，请勿重复操作',
            'TZ2010052' => '银行卡异常，请联系发卡银行',
            'TZ2010053' => '银行退款失败',
            'TZ2010054' => '银行预留手机号有误',
            'TZ2010055' => '余额不足',
            ...
            'TZ2010059' => '证件号码为空',
            'TZ2010060' => '支付记录不存在',
            'TZ2010061' => '支付失败，请稍候重试',
            'TZ2010062' => '重复的请求',
            'TZ2010063' => '验证码发送频率限制请稍候重试',
