...
class VipEnum extends AbstractEnum {
    ...
    public static $vipGrade = array(
            ...
            self::VIP_GRADE_QT => array('vipGrade' => 1, 'name' => '青铜会员', 'alias' => 'qt', 'minInvest' => 5, 'raiseInterest' => 0, 'giftValue' => 188, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/18/6d7f7d2f5445c7369cfb7a625cd155c9/index.jpg', 'privilege' => array(self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT, self::PRIVILEGE_ANNIVER_DISCOUNT, self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_CONSULTANT)),
            self::VIP_GRADE_BY => array('vipGrade' => 2, 'name' => '白银会员', 'alias' => 'by', 'minInvest' => 20, 'raiseInterest' => 0, 'giftValue' => 288, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/17/f1030f8c604ee7380ab1a648b7e4a4bc/index.jpg', 'privilege' => array(self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT,self::PRIVILEGE_ANNIVER_DISCOUNT,self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_CONSULTANT)),
            self::VIP_GRADE_HJ => array('vipGrade' => 3, 'name' => '黄金会员', 'alias' => 'hj', 'minInvest' => 50, 'raiseInterest' => 0.1, 'giftValue' => 388, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/18/9b64a4ae8f3fa2b63ac41ec7479f2519/index.jpg', 'privilege' => array(self::PRIVILEGE_INTEREST, self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT, self::PRIVILEGE_ANNIVER_DISCOUNT, self::PRIVILEGE_OFFLINE_SALON, self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_SENIOR_CONSULTANT)),
            self::VIP_GRADE_BJ => array('vipGrade' => 4, 'name' => '铂金会员', 'alias' => 'bj', 'minInvest' => 100, 'raiseInterest' => 0.11, 'giftValue' => 688, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/18/7857952d7bb8ae4c2c3561f8d9b4b711/index.jpg', 'privilege' => array(self::PRIVILEGE_INTEREST, self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT, self::PRIVILEGE_ANNIVER_DISCOUNT, self::PRIVILEGE_OFFLINE_SALON, self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_SENIOR_CONSULTANT)),
            self::VIP_GRADE_ZS => array('vipGrade' => 5, 'name' => '钻石会员', 'alias' => 'zs', 'minInvest' => 300, 'raiseInterest' => 0.12, 'giftValue' => 888, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/18/56496af28ac2a931c68dc8cc987f039e/index.jpg', 'privilege' => array(self::PRIVILEGE_INTEREST, self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT, self::PRIVILEGE_ANNIVER_DISCOUNT, self::PRIVILEGE_OFFLINE_SALON, self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_SENIOR_CONSULTANT)),
            self::VIP_GRADE_HG => array('vipGrade' => 6, 'name' => '皇冠会员', 'alias' => 'hg', 'minInvest' => 1000, 'raiseInterest' => 0.15, 'giftValue' => 1888, 'imgUrl' => 'http://static.firstp2p.com/attachment/201707/21/18/90ea5c6aef43457fc5cb6b0a12fda60f/index.jpg', 'privilege' => array(self::PRIVILEGE_INTEREST, self::PRIVILEGE_GIFT,self::PRIVILEGE_BIRTHDAY_DISCOUNT, self::PRIVILEGE_ANNIVER_DISCOUNT, self::PRIVILEGE_OFFLINE_SALON, self::PRIVILEGE_ASSET_CUSTOMIZE,self::PRIVILEGE_CUSTOMER_SERVICE,self::PRIVILEGE_SENIOR_CONSULTANT)),
    );
