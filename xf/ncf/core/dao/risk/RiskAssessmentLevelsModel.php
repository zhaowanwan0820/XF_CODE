...
class RiskAssessmentLevelsModel extends BaseModel
{
     ...
     * @return bool
     */
    public function addLevel($ques_id, $name, $lowest_score, $sort_order, $limitMoney, $totalLimitMoney)
    {
        $data = array(
            'ques_id'       => $ques_id,
            'name'          => $name,
            ...
            'total_limit_money'  => $totalLimitMoney,
        );
        $this->setRow($data);
     ...
     * @return bool
     */
    public function updateLevel($level_id, $ques_id, $name, $lowest_score, $sort_order, $limitMoney, $totalLimitMoney)
    {
