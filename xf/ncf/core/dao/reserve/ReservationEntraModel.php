...
class ReservationEntraModel extends BaseModel
{
     ...
     * @return array
     */
    public function getReserveEntraList($status = ReserveEntraEnum::STATUS_VALID, $limit = 0, $offset = 0)
    {
     ...
     * @return mix
     */
    public function getReserveEntra($investLine, $investUnit, $dealType, $investRate, $loantype, $status = ReserveEntraEnum::STATUS_VALID, $id = 0)
    {
