...
$(function() {
    ...
    $("#J_bid_submit").click(function(){
        zhuge.track('智多新_产品详情页_点击同意协议并加入') //埋点
    ...
    $(".j_xieyi").eq(0).on("click",function(){
        zhuge.track('智多新_产品详情页_点击查看顾问协议') //埋点
    })
    //协议弹出层
    $('body').on('click', '.j_xieyi', function() {
        var xieyi = $(this).attr("data-xieyi");
        if($(this).data('locked')){
           return;
        }
        $(this).data('locked',1);
