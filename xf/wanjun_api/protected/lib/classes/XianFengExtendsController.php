<?php
class XianFengExtendsController extends CController
{
    public $_IGET = array();
    public $_IPOST = array();
    ...
    public function __construct($id,$module)
    {
        ...
        $header = JwtClass::getHeader("X-WJ-AUTHORIZATION");
        if(isset($header['X-WJ-AUTHORIZATION']) && !empty($header['X-WJ-AUTHORIZATION'])){
            $getPayload = JwtClass::verifyToken($header['X-WJ-AUTHORIZATION']);
            $this->user_id = !empty($getPayload['user_id']) ? $getPayload['user_id'] : '';
        }
        $this->xss_filter();
    }
