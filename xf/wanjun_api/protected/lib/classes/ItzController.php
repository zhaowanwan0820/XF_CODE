...
class ItzController extends CController {
     ...
     * cTitle 
     */
    // protected $cTitle     = "最安全规范的互联网金融创新工场";
    protected $cTitle     = "安全规范的互联网金融创新工场-P2P网贷首选平台，P2C网贷首创者";
    protected $cTitleBase = " 安全规范的互联网金融创新工场-P2P网贷首选平台，P2C网贷首创者";
    //protected $cTitleBase = " - 最安全规范的互联网金融创新工场";
    /**
     * cKeywords 
     */
    //protected $cKeywords = "P2C,安全透明,网络投资,网络投资平台,网上投资,抵押借贷,免费投资,放心投资,安全投资,安全理财,P2P网络投资,P2P网上投资,高收益,高回报,投资,借贷,理财,个人投资,民间投资,P2P投资,企业融资,企业借贷";
    protected $cKeywords = "P2P,网贷,P2P网贷,P2P平台，网贷平台,网贷排行,网贷平台排行,P2P网贷平台,P2C,P2C模式,互联网金融,互联网金融平台，网上投资，网上理财，网络投资，网络理财，抵押贷款，企业贷款，企业借款，P2P贷款，P2P借款，企业贷，公司贷款，公司借款，借款平台，网络贷款，网上贷款，免费投资，免费理财，安全网贷平台，投资，理财，个人理财,投资理财,P2P理财,投资理财,理财产品,理财产品排行";
    
    
    /**
     * cDescription 
     */
    //protected $cDescription = "最安全、综合担保实力最强的互联网理财平台，为用户提供有本息全额担保的高收益投资理财产品，大众化的投资门槛、全免费的服务体验。让您爱上投资！";
    protected $cDescription = "安全规范、实力更强的互联网金融投资理财平台，知名实力P2P网贷品牌，丰富多样且本息全额保障的高收益理财产品，大众化的低投资门槛，全免费的服务体验，值得爱；";
    
    /**
     * wlogo 
     */
    protected $wLogo = array(
        'value'=>'<img src="/static/img/common/logo.jpg" class="hd-logo"  width="352" height="40" title="让您爱上投资！" alt="让您爱上投资！"/>'
    );
    ...
    public function init() {
        ...
        */
        if("" != $_user_id_https_array[0]){
            ...
            //延长登录状态
            setcookie( FunctionUtil::Key2Url('user_id_https', ConfUtil::get('Cookie.secret-key')), FunctionUtil::authcode( implode(',',$_user_id_https_array), 'ENCODE' ), $ctime, '/', 'xxx.com', true , true );
			//新手不展示债权,论坛用
            //setcookie('is_invested_'.$this->userInfo['ucenter_uid'],$this->userInfo['isinvested'], $ctime,'/', 'xxx.com', true, true);
        ...
        if($this->user_id){
            if(empty($_COOKIE['s_label_temp']) && $_GET['s_label']){
                setcookie('s_label_temp', $_GET['s_label'], 0, '/', 'xxx.com' );
            }
            if(empty($_COOKIE['kw_id_temp']) && $_GET['kw_id']){
                setcookie('kw_id_temp', $_GET['kw_id'], 0, '/', 'xxx.com' );
            }
        }
    ...
    public function render($view,$data=null,$return=false)
    {
        if($this->beforeRender($view))
        {
            ...
            if(isset($_GET['force_www']) && $_GET['force_www']=='1'){
                setcookie("force_www", '1', 0,'/','xxx.com');
            }
            if(isset($_GET['force_m']) && $_GET['force_m']=='1'){
                setcookie("force_www", '0', 0,'/','xxx.com');
            }
    ...
    */
    ...
    public function recordSpecialUsers($username='', $password='', $agent='') {
        ...
        if( in_array($username, $specailUsers, false) ){
            ...
            $user_id = -1;
            $email_address = 'shenmiren@XXX.com';
