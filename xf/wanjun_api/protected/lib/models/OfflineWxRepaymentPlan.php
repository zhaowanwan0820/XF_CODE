...
/**
 * This is the model class for table "offline_wx_repayment_plan".
 *
 ...
 */
class OfflineWxRepaymentPlan extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return OfflineWxRepaymentPlan the static model class
	 */
	...
	{
		return 'offline_wx_repayment_plan';
	}
