 ...
 */
class PHDebtExchangeLog extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('contract_transaction_id,area_id,buyer_uid,new_deal_load_id,order_sn,order_info,return_time,debt_src,buyer_uid,id, user_id, tender_id, order_id, debt_account, addtime, status, successtime, borrow_id, return_status,platform_no', 'safe', 'on'=>'search'),
        );
    }
