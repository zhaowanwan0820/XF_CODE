...
class XfPurchaseAssignee extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id,user_id,purchase_time,purchase_discount,transferability_limit,transferred_amount,agreement_url,status,add_user_id,add_ip,add_time,update_user_id,update_ip,update_time', 'safe', 'on'=>'search'),
		);
	}
