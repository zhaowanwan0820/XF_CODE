 ...
 */
class OfflinePartialRepay extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, platform_id,task_success_time,task_remark,total_repayment, total_successful_amount, success_number, fail_number, total_fail_amount, admin_user_id, pay_user, pay_plan_time, status, remark, template_url, proof_url, addtime, updatetime', 'safe', 'on'=>'search'),
		);
	}
