...
class OfflineDealLoanRepay extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('old_repay_log_id,old_repay_num,id,platform_id, last_part_repay_time,repaid_amount,deal_id, deal_repay_id, deal_loan_id, loan_user_id, borrow_user_id, money, type, time, real_time, status, deal_type, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
