 ...
 */
class ContractTask extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('platform_no,task_id, type, borrow_id, tender_id, user_id, status, version, download,oss_download, investtime, addtime, handletime', 'safe', 'on'=>'search'),
		);
	}
