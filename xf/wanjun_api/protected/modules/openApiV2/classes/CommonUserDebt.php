        ...
        try {
            ...
            if ($tenderIds_PH) {
                ...
                foreach ($canDebtTendersInfo as $orderTender) {
                    ...
                    $n+=1;
                    if ($n<=25) {
                        $deal_load_content .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>25 && $n<= 57) {
                        $deal_load_content_01 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>57 && $n<= 89) {
                        $deal_load_content_02 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>89 && $n<= 121) {
                        $deal_load_content_03 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>121 && $n<= 153) {
                        $deal_load_content_04 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>153 && $n<= 185) {
                        $deal_load_content_05 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>185 && $n<= 217) {
                        $deal_load_content_06 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>217 && $n<= 249) {
                        $deal_load_content_07 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>249 && $n<= 281) {
                        $deal_load_content_08 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>281 && $n<= 313) {
                        $deal_load_content_09 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>313 && $n<= 345) {
                        $deal_load_content_10 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                    if ($n>345 && $n<= 377) {
                        $deal_load_content_11 .= "序号{$n}：合同编号：{$seller_contract_number}；项目名称：{$orderTender['name']}；转让债权本金：{$orderTender['debt_account']}元整。\r\n";
                    }
                }
                //批量写入
