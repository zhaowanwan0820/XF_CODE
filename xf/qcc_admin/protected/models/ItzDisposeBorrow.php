...
class ItzDisposeBorrow extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, type, dispose_type, borrow_id, wise_borrow_id, style, apr, dispose_capital, value_date, repay_time, status, addtime, cycle, start_time, content, next_value_date, process_time, repay_num, s_id, loan_contract_number, repay_deal_status', 'safe', 'on'=>'search'),
		);
	}
