...
//            'enableCookieValidation'=>true,
        ...
        'user' => [
            ...
            'identityCookie' => ['domain' => '.itouzi.com', 'path' => '/'],
        ...
        'log' => [
            ...
            'routes' => [
                [
                    ...
                    'logFile' => 'yii_itouzi_ccs_access.log',
                    'maxFileSize' => 2097152
                ],
                [
                    'class' => 'CFileLogRoute',
                    ...
                    //支持日期格式,{}中的为日期格式
                    'logPath' => ConfUtil::get('logPath'),
                    'logFile' => 'yii_itouzi_ccs_error.log',
                    'maxFileSize' => 2097152
                ],
                [
                    'class' => 'CFileLogRoute',
...
//                ],
        ...
        'c' => [
            ...
            //'xw_request_url' => \itzlib\sdk\ServiceUtil::getAddress('com.itouzi.trustee') . '/trustee/v1',
            ...
            //oss预览地址
            "oss_preview_address" => "https://zhaizhuan.huanhuanyiwu.com",
            // 消费专区ID
