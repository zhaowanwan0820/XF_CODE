    ...
    <div class="layui-row">
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input lay-verify="userType" type="radio" name="user_type" value="1" title="常规类型" <{if $userInfo['user_type'] == 1}>checked<{/if}>>
                    <input lay-verify="userType" type="radio" name="user_type" value="2" title="咨询方类型" <{if $userInfo['user_type'] == 2}>checked<{/if}>>
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>
                </div>
