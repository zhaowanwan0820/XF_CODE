...
class IAuthController extends \DController
{
    ...
    public function checkRole(){
        ...
        //判断登录排除
        if(!in_array($_SERVER["REQUEST_URI"],array('/default/index/loginccs','/default/index/index','/logout','/'))){
            //是否登录
            ...
            if(strpos(strtolower($authList),trim(strtolower($thisUrl))) === false){
                ...
                echo "<script>alert('您没有此操作权限')</script>";die;
