    ...
    <script>
      ...
      function daochu() {
        ...
        function(index) {
          ...
          var start         = $("#start").val();
          var end           = $("#end").val();
          window.open("/user/Debt/DebtListExcel?deal_type="+deal_type+"&status="+status+"&debt_src="+debt_src+"&channel_id="+channel_id+"&load_src="+load_src+"&serial_number="+serial_number+"&user_id="+user_id+"&name="+name+"&mobile="+mobile+"&borrow_id="+borrow_id+"&tender_id="+tender_id+"&company="+company+"&advisory="+advisory+"&start="+start+"&end="+end+"&t_user_id="+t_user_id+"&t_mobile="+t_mobile , "_blank");
        });
      }
    </script>
