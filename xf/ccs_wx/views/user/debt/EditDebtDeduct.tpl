...
<html class="x-admin-sm">
    ...
    <body>
                ...
                <form class="layui-form" method="post" action="/user/Debt/EditDebtDeduct" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                        <input type="radio" class="deal_type" name="deal_type" value="1" title="尊享" <{if $info['deal_type'] eq '1'}>checked<{/if}>>
                        <input type="radio" class="deal_type" name="deal_type" value="2" title="普惠" <{if $info['deal_type'] eq '2'}>checked<{/if}>>
                      </div>
                    </div>
        ...
        function do_add() {
          ...
          if (id == '') {
            layer.alert('请输入记录ID');
          } else if (deal_type != 1 && deal_type != 2) {
            layer.alert('请选择所属平台');
