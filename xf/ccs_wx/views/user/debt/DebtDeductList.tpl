                                      ...
                                      <div class="layui-form-item">
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <input type="radio" name="deal_type" value="1" title="尊享" <{if $deal_type eq '1'}> checked <{/if}> >
                                            <input type="radio" name="deal_type" value="2" title="普惠" <{if $deal_type eq '2'}> checked <{/if}> >
                                          </div>
                                        </div>
