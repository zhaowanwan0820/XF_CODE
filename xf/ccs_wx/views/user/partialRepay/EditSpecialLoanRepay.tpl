            ...
            <div class="layui-row">
                <form class="layui-form" action="/user/PartialRepay/EditSpecialLoanRepay" method="post" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="project_product_class_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="deal_name_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                    </div>
