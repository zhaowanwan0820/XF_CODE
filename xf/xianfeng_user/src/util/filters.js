...
Vue.filter('convertTime2', function(timeStamp) {
  return utils.formatDate('YYYY-MM-DD', timeStamp)
})
Vue.filter('convertTime3', function(timeStamp) {
  return utils.formatDate('MM-DD HH:mm', timeStamp)
})
Vue.filter('convertTime4', function(timeStamp) {
  return utils.formatDate('YYYY-MM-DD HH:mm', timeStamp)
})
...
Vue.filter('formatMoney', function(value) {
  return utils.formatMoney(value, true)
})
