            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <div class="layui-row">
                        ...
                        <div class="layui-col-md4">
                            <span class="x-red">*</span><span style="font-size: 13px;">当前待还本金和：<{$dealInfo['new_principal']}>元</span>
                        </div>
                        <div class="layui-col-md4">
                            <span class="x-red">*</span> <span style="font-size: 13px;">当前待还利息和：<{$dealInfo['new_interest']}>元</span>
                        </div>
                        <div class="layui-col-md4">
            ...
            <div class="layui-card">
                ...
                <div class="layui-tab layui-tab-brief" lay-filter="table-all">
                    <ul class="layui-tab-title">
                        <li data-status="0" class="layui-this" id='repay_log' style="font-size: 14px;" onclick="repayLogShow()">还款计划</li>
