                            ...
                            <div class="layui-colla-content layui-show">
                                <form class="layui-form" >
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            <label class="layui-form-label">末次划扣时间</label>
                                            <div class="layui-input-inline"  style="width: 85px;">
...
<script>
    layui.use(['laydate', 'table', 'layer', 'form'], function () {
        ...
        var join = [
            ...
            {field: 'new_principal', title: '待还本金和', width: 120},
            {field: 'new_interest', title: '待还利息和', width: 120},
            ...
            {field: 'xf_last_repay_time', title: '末次划扣时间', width: 120}, 
