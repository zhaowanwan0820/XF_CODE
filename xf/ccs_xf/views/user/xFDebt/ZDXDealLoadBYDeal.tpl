                                ...
                                <form class="layui-form" action="">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <input type="text" name="user_name" id="user_name" placeholder="请输入融资方名称" autocomplete="off" class="layui-input">
                                            </div>
                                        </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/XFDebt/ZDXDealLoadBYDeal',
          method   : 'post',
          where    : {deal_type : 4},
          response :
          {
        ...
        form.on('submit(sreach_a)', function(obj){
          ...
          if (obj.field.type == 0) {
            ...
            xadmin.open('通过上传融资方名称查询','/user/XFDebt/addDealLoadBYDealCondition?deal_type=4&type=1');
          } else if (obj.field.type == 2) {
            xadmin.open('通过上传融资经办机构名称查询','/user/XFDebt/addDealLoadBYDealCondition?deal_type=4&type=2');
          } else if (obj.field.type == 3) {
            xadmin.open('通过上传融资担保机构名称查询','/user/XFDebt/addDealLoadBYDealCondition?deal_type=4&type=3');
          }
          return false;
        });
      ...
      function DealLoadBYDeal2ExcelA()
      {
        ...
        if (deal_id == '' && deal_name == '' && project_id == '' && project_name == '' && jys_record_number == '' && user_name == '' && advisory_name == '' && agency_name == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/ZDXDealLoadBYDeal2Excel?deal_type=4&deal_id="+deal_id+"&deal_name="+deal_name+"&project_id="+project_id+"&project_name="+project_name+"&jys_record_number="+jys_record_number+"&user_name="+user_name+"&advisory_name="+advisory_name+"&agency_name="+agency_name , "_blank");
          });
        }
      }
      ...
      function DealLoadBYDeal2ExcelB()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/ZDXDealLoadBYDeal2Excel?deal_type=4&condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
