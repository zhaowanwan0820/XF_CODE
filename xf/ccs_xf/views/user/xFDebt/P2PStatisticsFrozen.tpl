...
<html class="x-admin-sm">
                                  ...
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        <div class="layui-input-block">
                                          ...
                                          <{if $P2PStatistics2FrozenExcel == 1 }>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          elem           : '#list',
          toolbar        : '<div><i class="iconfont" style="color:orange;">&#xe6b6;</i> 统计排除冻结债权后截至当日零时全量数据。</div>',
          ...
          url      : '/user/XFDebt/P2PStatisticFrozen',
          method   : 'post',
          response :
          {
            statusName : 'code',
      ...
      function P2PStatistics2Excel()
      {
        ...
        if (start == '' && end == '' && platform == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/XFDebt/P2PStatistics2FrozenExcel?start="+start+"&end="+end+"&platform="+platform , "_blank");
          });
        }
      }
    </script>
