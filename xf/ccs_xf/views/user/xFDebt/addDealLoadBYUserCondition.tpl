...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <{if $end == 0 }>
                <form class="layui-form" method="post" action="/user/XFDebt/addDealLoadBYUserCondition" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux"><span class="x-red">*</span>请上传 xls 文件（数据量不可超过一万行） <a href="/user/XFDebt/addDealLoadBYUserCondition?download=<{$_GET['type']}>" style="color: blue;">下载模板</a></div>
                    </div>
