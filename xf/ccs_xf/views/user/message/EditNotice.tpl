            ...
            <div class="layui-row">
              <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="title" name="title" lay-verify="required" autocomplete="off" class="layui-input" value="<{$res['title']}>" style="width: 300px;" onkeyup="check_title()" onchange="check_title()"></div>
                ...
                <div class="layui-form-item">
                    <label for="abstract" class="layui-form-label">
                        摘要</label>
                    <div class="layui-input-inline">
                        <input type="text" id="abstract" name="abstract" autocomplete="off" class="layui-input" value="<{$res['abstract']}>" style="width: 400px;" onkeyup="check_abstract()" onchange="check_abstract()"></div>
