    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/Automatch/PHPartialRepayDetail',
          method   : 'post',
          where    : {id:<{$_GET['id']}>},
          response :
          {
      ...
      function daochu()
      {
        ...
        function(index) {
          layer.close(index);
          window.open("/user/Automatch/PHPartialRepayExcel?id=<{$_GET['id']}>&name="+name+"&deal_loan_id="+deal_loan_id+"&user_id="+user_id+"&status="+status+"&repay_status="+repay_status , "_blank");
        });
      }
