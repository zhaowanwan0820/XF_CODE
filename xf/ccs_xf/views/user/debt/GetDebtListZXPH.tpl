                                  ...
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <select name="debt_src" id="debt_src" lay-search="" lay-filter="debt_src">
                                              <option value="">全部</option>
                                              ...
                                              <option value="6">权益兑换退回</option>
                                                <option value="7">债权置换</option>
                                            </select>
                                          </div>
                                        </div>

                                        <div class="layui-inline" id="platform_no_div" style="display: none;">
                                          <label class="layui-form-label">兑换平台</label>
                                          <div class="layui-input-inline">
                                            <select name="platform_no" id="platform_no" lay-search="">
                                              <option value="">全部</option>
                                              <option value="1">有解</option>
                                              <option value="2">悠融优选</option>
                                            </select>
                                          </div>
                                        </div>
    ...
    <script>
      ...
      function daochu() {
        ...
        if (status == '' && debt_src == '' && platform_no == '' && channel_id == '' && serial_number == '' && user_id == '' && mobile == '' && borrow_id == '' && name == '' && tender_id == '' && company == '' && advisory == '' && t_user_id == '' && t_mobile == '' && start == '' && end == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Debt/DebtListExcelZXPH?deal_type="+deal_type+"&status="+status+"&debt_src="+debt_src+"&platform_no="+platform_no+"&channel_id="+channel_id+"&serial_number="+serial_number+"&user_id="+user_id+"&name="+name+"&mobile="+mobile+"&borrow_id="+borrow_id+"&tender_id="+tender_id+"&company="+company+"&advisory="+advisory+"&start="+start+"&end="+end+"&t_user_id="+t_user_id+"&t_mobile="+t_mobile , "_blank");
          });
        }
      }
      ...
      function DebtListExcel()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Debt/DebtListExcelZXPH?condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
