    ...
    <div class="" id="info-detail" v-cloak>
      ...
      <div class="debt-info-wrapper">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            <el-col :span="12" class="name">发起判定原因：</el-col>
            <el-col :span="12" class="num">{{ info.decision_outaccount }}</el-col>
          </el-col>
        </el-row>
      </div>
      ...
      <!-- btn box -->
      <div class="btn-box" v-if="operation == 2 && info.status != 2 && info.status != 1 && info.status != 4 && info.status != 3">
