...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/user/Debt/EditDebtDeduct" id="my_form" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                        <select name="deal_type" id="deal_type" lay-search="">
                          <option value="1" <{if $info['deal_type'] eq '1'}>selected<{/if}>>尊享</option>
                          <option value="2" <{if $info['deal_type'] eq '2'}>selected<{/if}>>普惠</option>
                          <option value="3" <{if $info['deal_type'] eq '3'}>selected<{/if}>>工场微金</option>
                          <option value="4" <{if $info['deal_type'] eq '4'}>selected<{/if}>>智多新</option>
                          <option value="5" <{if $info['deal_type'] eq '5'}>selected<{/if}>>交易所</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="user_id" autocomplete="off" class="layui-input" disabled value="<{$info['user_id']}>"></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="tender_id" name="tender_id" autocomplete="off" class="layui-input" value="<{$info['tender_id']}>"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label for="deal_id" class="layui-form-label">
                            借款ID</label>
                        <div class="layui-input-inline">
                            <input type="text" id="deal_id" name="deal_id" autocomplete="off" class="layui-input" value="<{$info['deal_id']}>"></div>
                        <div class="layui-form-mid layui-word-aux">
                          非必填,与借款标题二选一
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label for="deal_name" class="layui-form-label">
                            借款标题</label>
                        <div class="layui-input-inline">
                            <input type="text" id="deal_name" name="deal_name" autocomplete="off" class="layui-input" value="<{$info['deal_name']}>"></div>
                        <div class="layui-form-mid layui-word-aux">
                          非必填,与借款ID二选一
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="buyback_user_id" name="buyback_user_id" autocomplete="off" class="layui-input" value="<{$info['buyback_user_id']}>"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="debt_account" name="debt_account" autocomplete="off" class="layui-input" value="<{$info['debt_account']}>"></div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <span id="file_name"><{$info['agreement_pic_a']}></span>
        ...
        function do_add() {
          ...
          var agreement_pic   = $("#agreement_pic").val();
          if (id == '') {
            layer.alert('请输入记录ID');
          } else if (deal_type != 1 && deal_type != 2 && deal_type != 3 && deal_type != 4 && deal_type != 5) {
            layer.alert('请选择所属平台');
