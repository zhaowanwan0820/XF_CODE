...
<html class="x-admin-sm">
                                  ...
                                  <form class="layui-form" action="">
                                      ...
                                      <div class="layui-form-item">
                                        ...
                                        <div class="layui-inline">
                                          ...
                                          <div class="layui-input-inline">
                                            <select name="da_status" id="da_status" lay-search="">
                                              <option value="1">客服介入待处理</option>
                                              <option value="2">判定有效交易</option>
                                              <option value="3">判定无效交易</option>
                                            </select>
                                          </div>
                                        </div>

                                          <div class="layui-inline">
                                              <label class="layui-form-label">转入判定方式</label>
                                              <div class="layui-input-inline">
                                                  <select name="type" id="type" lay-search="">
                                                      <option value="2">转让人主动申请转入</option>
                                                      <option value="1">超时未确认自动转入</option>
                                                  </select>
                                              </div>
                                          </div>
    ...
    <script>
      layui.use(['form' , 'layer' , 'table' , 'laydate'] , function(){
        ...
        table.render({
          ...
          url      : '/user/Debt/HyDebtAppealA',
          method   : 'post',
          where    : {type : 2 , deal_type : 2 , da_status : 1},
          response :
          {
            statusName : 'code',
            statusCode : 0,
    ...
    <script type="text/html" id="operate">
      ...
      {{# } else { }}
      <button class="layui-btn layui-btn-xs" title="详情" lay-event="appeal">详情</button>
      {{# } }}
    </script>
</html>