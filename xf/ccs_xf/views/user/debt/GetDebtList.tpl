    ...
    <script>
      ...
      function daochu() {
        ...
        if (status == '' && debt_src == '' && platform_no == '' && channel_id == '' && serial_number == '' && user_id == '' && mobile == '' && borrow_id == '' && name == '' && tender_id == '' && company == '' && advisory == '' && t_user_id == '' && t_mobile == '' && start == '' && end == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Debt/DebtListExcel?deal_type="+deal_type+"&status="+status+"&debt_src="+debt_src+"&platform_no="+platform_no+"&channel_id="+channel_id+"&serial_number="+serial_number+"&user_id="+user_id+"&name="+name+"&mobile="+mobile+"&borrow_id="+borrow_id+"&tender_id="+tender_id+"&company="+company+"&advisory="+advisory+"&start="+start+"&end="+end+"&t_user_id="+t_user_id+"&t_mobile="+t_mobile , "_blank");
          });
        }
      }
      ...
      function DebtListExcel()
      {
        ...
        if (condition_id == '') {
          ...
          function(index) {
            layer.close(index);
            window.open("/user/Debt/DebtListExcel?condition_id="+condition_id , "_blank");
            reset_condition();
          });
        }
      }
