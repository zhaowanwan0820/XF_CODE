...
<html class="x-admin-sm">
    ...
    <body>
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" method="post" action="/user/exclusivePurchase/EditAssignee" enctype="multipart/form-data" id="my_form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux user_id_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="purchase_time" id="purchase_time" autocomplete="off" class="layui-input" value="<{$res['purchase_time']}>"  ></div>
                        <div class="layui-form-mid layui-word-aux" id="limit_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                        <div class="layui-form-mid layui-word-aux">可修改</div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="purchase_discount" id="purchase_discount" autocomplete="off" class="layui-input" value="<{$res['purchase_discount']}>" ></div>
                        <div class="layui-form-mid layui-word-aux" id="limit_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                        <div class="layui-form-mid layui-word-aux">可修改</div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux" id="file_status"><i class="iconfont" style="color: #009688;">&#xe6b1;</i></div>
                        <div class="layui-form-mid layui-word-aux">请上传压缩文件（rar，zip，7z）</div>
                    </div>

                    <div class="layui-form-item" id="file_a_div" >
                        <label class="layui-form-label">分配用户ID文件</label>
                        <div class="layui-input-inline">
                        ...
                        <div class="layui-form-mid layui-word-aux">请上传 xlsx 文件（数据量不可超过十万行） <a href="/user/exclusivePurchase/EditAssignee?download=1" style="color: blue;">下载模板</a></div>
                    </div>
        ...
        function add() {
          ...
          var file_a  = $("#file_a").val();
           ...
           if (isNaN(limit) || limit < amount || limit > 1000000000) {
