                                                ...
                                                <ul class="main_data layui-row layui-col-space10 layui-this x-admin-carousel x-admin-backlog">
                                                    <li class="layui-col-md6 layui-col-xs18" >
                                                        <a href="javascript:;" class="x-admin-backlog-body" style="height: 130px;padding-top: 80px;">
                                                            ...
                                                            <p >
                                                                <cite style="font-size: 25px; color: #f36b38;font-weight:bold"><{$platform_data['debt_number_total']|number_format:0}></cite></p>
                                                        </a>
                                                    </li>
                                                    <li class="layui-col-md6 layui-col-xs18">
                                                        <a href="javascript:;" class="x-admin-backlog-body" style="height: 130px;padding-top: 80px;">
                                                            ...
                                                            <p>
                                                                <cite style="font-size: 25px; color: #f36b38;font-weight:bold"><{$platform_data['debt_total']|number_format:0}></cite>
                                                            </p>
                                                        </a>
                                                    </li>
                                                    <li class="layui-col-md6 layui-col-xs18">
                                                        <a href="javascript:;" class="x-admin-backlog-body" style="height: 130px;padding-top: 80px;">
                                                            ...
                                                            <p>
                                                                <cite style="font-size: 25px; color: #f36b38;font-weight:bold"><{$platform_data['order_total']|number_format:0}></cite></p>
                                                        </a>
                                                    </li>
                                                    <li class="layui-col-md6 layui-col-xs18">
                                                        <a href="javascript:;" class="x-admin-backlog-body" style="height: 130px;padding-top: 80px;">
                                                            ...
                                                            <p>
                                                                <cite style="font-size: 25px; color: #f36b38;font-weight:bold"><{$platform_data['residual_integral']|number_format:0}></cite></p>
                                                        </a>
                                                    </li>
