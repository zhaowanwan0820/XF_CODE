        ...
        <div class="form">
            <form id="itz-channel-user-form">
                ...
                <div class="row rowSpacing">
                    ...
                    <span class="text-middle">*</span>
                    <input size="50" name="user[username]" ng-model="user.username" id="iauth_mail" required="required" type="text"><span class="fontSize" style="margin-left: 5px;" >@zichanhuayuan.com</span><span class="errorMess" id="usernameerror"></span>
                </div>
                <div class="row rowSpacing">
