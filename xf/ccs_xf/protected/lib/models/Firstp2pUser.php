 ...
 * @property string $fdd_customer_id
 * @property integer $has_debt_confirm
 * @property integer $has_debt_authentication
 * @property integer $debt_money_confirm_time
 * @property integer $debt_lock_money_confirm_time
 * @property integer $authentication_time
 * @property integer $read_flag
 * @property integer $read_time
 * @property string $transaction_password
 * @property integer $level_risk_id
 * @property integer $agree_status
 * @property string $debt_email
 * @property string $yj_fdd_customer_id
 * @property string $ph_money
 * @property string $ph_lock_money
 * @property string $zx_recharge
 * @property string $zx_withdraw
 * @property string $ph_recharge
 * @property string $ph_withdraw
 * @property integer $is_online
 */
class Firstp2pUser extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Firstp2pUser the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('passport_id, h_idno, t_idno, m_idno, money, lock_money, edu_validcode, postcode, invite_code, ph_money, ph_lock_money, zx_recharge, zx_withdraw, ph_recharge, ph_withdraw', 'length', 'max'=>20),
			array('passport_no, military_id, other_idno', 'length', 'max'=>64),
			array('real_name, car_brand, car_number, phone, act_name, transaction_password', 'length', 'max'=>50),
	...
	public function attributeLabels()
	{
		return array(
			...
			'version_id' => 'Version',
			'act_name' => 'Act Name',
			'fdd_customer_id' => 'Fdd Customer',
			'has_debt_confirm' => 'Has Debt Confirm',
			'has_debt_authentication' => 'Has Debt Authentication',
			'debt_money_confirm_time' => 'Debt Money Confirm Time',
			'debt_lock_money_confirm_time' => 'Debt Lock Money Confirm Time',
			'authentication_time' => 'Authentication Time',
			'read_flag' => 'Read Flag',
			'read_time' => 'Read Time',
			'transaction_password' => 'Transaction Password',
			'level_risk_id' => 'Level Risk',
			'agree_status' => 'Agree Status',
			'debt_email' => 'Debt Email',
			'yj_fdd_customer_id' => 'Yj Fdd Customer',
			'ph_money' => 'Ph Money',
			'ph_lock_money' => 'Ph Lock Money',
			'zx_recharge' => 'Zx Recharge',
			'zx_withdraw' => 'Zx Withdraw',
			'ph_recharge' => 'Ph Recharge',
			'ph_withdraw' => 'Ph Withdraw',
			'is_online' => 'Is Online',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('fdd_customer_id',$this->fdd_customer_id,true);
		$criteria->compare('has_debt_confirm',$this->has_debt_confirm);
		$criteria->compare('has_debt_authentication',$this->has_debt_authentication);
		$criteria->compare('debt_money_confirm_time',$this->debt_money_confirm_time);
		$criteria->compare('debt_lock_money_confirm_time',$this->debt_lock_money_confirm_time);
		$criteria->compare('authentication_time',$this->authentication_time);
		$criteria->compare('read_flag',$this->read_flag);
		$criteria->compare('read_time',$this->read_time);
		$criteria->compare('transaction_password',$this->transaction_password,true);
		$criteria->compare('level_risk_id',$this->level_risk_id);
		$criteria->compare('agree_status',$this->agree_status);
		$criteria->compare('debt_email',$this->debt_email,true);
		$criteria->compare('yj_fdd_customer_id',$this->yj_fdd_customer_id,true);
		$criteria->compare('ph_money',$this->ph_money,true);
		$criteria->compare('ph_lock_money',$this->ph_lock_money,true);
		$criteria->compare('zx_recharge',$this->zx_recharge,true);
		$criteria->compare('zx_withdraw',$this->zx_withdraw,true);
		$criteria->compare('ph_recharge',$this->ph_recharge,true);
		$criteria->compare('ph_withdraw',$this->ph_withdraw,true);
