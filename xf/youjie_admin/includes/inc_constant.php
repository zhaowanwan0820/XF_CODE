...
define('ACT_REFUND',               97);     // 部分退款
define('ACT_REFUND_SURPLUS',        5);     // 退还权益币
define('ACT_DEBT_ROLLBACK',        100);    // 退回债权

/* 浣豆账户变动类型 */
define('TOKNE_CHANGE',              0);     // 份额变化(包含下单平台代付和充值)
define('TOKNE_COST',                1);     // 浣豆消费
define('TOKNE_SIGN',                2);     // 签到送豆
define('TOKNE_REFUND',              3);     // 订单退款
...
/* 新的订单状态 很可能就夭折的 */
define('SB_OS_WAITING_SEND',0); // 待发货
define('SB_OS_ALREADY_SEND',1); // 已发货
define('SB_OS_DEALS_SUCCESS',2); // 处理成功
define('SB_OS_AFTER_SALE',3); // 售后
define('SB_OS_CANCEL',4); // 取消


// 订单类型
define('OT_NORMAL', 0);
define('OT_INSTALMENT', 1);

// 分期订单
define('INSTALMENT_OS_DEFAULT', 0);
define('INSTALMENT_OS_CONFIRMED', 1);
define('INSTALMENT_OS_CANCEL', 2);

define('INSTALMENT_PS_UNPAY', 0);
define('INSTALMENT_PS_PAYING', 1);
define('INSTALMENT_PS_PAYED', 2);

// 会员账户调节审核
define('ACCOUNT_CHANGE_AUDIT_DEFAULT', 1); // 默认变动类型
define('ACCOUNT_CHANGE_AUDIT_OFFLINE_HUANBI', 2); // 订单线下积分退款

// 商家类型
define('COO_RESIDENT', 1); // 入驻商类型 
define('COO_SUPPLIERS', 2); // 供应商类型

// 平台账户
define('PLATFORM_ACCOUNT_ID', 1); // 平台账户ID
define('CT_HUANBI_OFFLINE', 4); // 供应商订单线下线下退积分

define('HUANBI_SETTLEMENT', 1); // 订单结算积分
define('HUANBI_UNSETTLEMENT', 0); // 订单不结算积分
