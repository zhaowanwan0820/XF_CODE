...
{
    $GLOBALS['smarty']->assign('goods_list', get_home_goods());
...
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 6;
//                $GLOBALS['smarty']->assign('goods_spsx', get_home_goods($attr));
//                /* 美妆护肤 */
//                $attr = [];
//                $attr['cat_id']      = [808];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 7;
//                $GLOBALS['smarty']->assign('goods_mzhf', get_home_goods($attr));
//                /* 服饰内衣 */
//                $attr = [];
//                $attr['cat_id']      = [807];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 8;
//                $GLOBALS['smarty']->assign('goods_fsny', get_home_goods($attr));
//                /* 家用电器 */
//                $attr = [];
//                $attr['cat_id']      = [803];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 9;
//                $GLOBALS['smarty']->assign('goods_jydq', get_home_goods($attr));
//                /* 珠宝配饰 */
//                $attr = [];
//                $attr['cat_id']      = [804];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 11;
//                $GLOBALS['smarty']->assign('goods_zbps', get_home_goods($attr));
//                /* 家具清洁 */
//                $attr = [];
//                $attr['cat_id']      = [810];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 10;
//                $GLOBALS['smarty']->assign('goods_jjqj', get_home_goods($attr));
//                /* 箱包鞋靴 */
//                $attr = [];
//                $attr['cat_id']      = [809];
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 12;
//                $GLOBALS['smarty']->assign('goods_xbxx', get_home_goods($attr));
//                /* 以物抵债 */
//                $attr = [];
//                $attr['sort_key']    = 6;
//                $attr['sort_value']  = 2;
//                $attr['admin_order'] = 1;
//                $attr['tags_id']     = 13;
//                $GLOBALS['smarty']->assign('goods_ywdz', get_home_goods($attr));
//            break;
//            case 2:
//                /* 品牌的商品 */
