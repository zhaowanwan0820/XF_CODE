<?php
    ...
    function API_UserLogin($post)
    {
        ...
        /* 检查密码是否正确 */
        $sql = "SELECT user_id, user_name, password, action_list, last_login, type, suppliers_id, is_suppliers ".
    ...
    function API_AddGoods($post)
    {
        ...
        $is_sell_out = (isset($_POST['is_sell_out']) && $_POST['is_sell_out']) ? 1 : 0;
        ...
        if ($is_insert)
        {
            if ($code == '')
            {
                $sql = "INSERT INTO " . $GLOBALS['ecs']->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                        ...
                        "is_on_sale, is_sell_out, is_alone_sale, goods_desc, add_time, last_update, goods_type)" .
                    "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                        "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                        "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                        "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                        " '$warn_number', '$_POST[integral]', '" . intval($_POST['give_integral']) . "', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_sell_out', '$is_alone_sale', ".
            ...
            else
            {
                $sql = "INSERT INTO " . $GLOBALS['ecs']->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                        ...
                        "is_on_sale, is_sell_out, is_alone_sale, goods_desc, add_time, last_update, goods_type, extension_code)" .
                    "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                        "'$brand_id', '$shop_price', '$market_price', '$is_promote', '$promote_price', ".
                        "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                        "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                        " '$warn_number', '$_POST[integral]', '" . intval($_POST['give_integral']) . "', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_sell_out', '$is_alone_sale', ".
    ...
    function API_GetGoods($post)
    {
        ...
        foreach ($result['Data'] as $key => $goods)
        {
            ...
            $result['Data'][$key]['is_sell_out'] = ($goods['is_sell_out'] == 1);
