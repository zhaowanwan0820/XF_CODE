...
function update_region_timestamp() {
    $sql = 'INSERT INTO ' . $GLOBALS['ecs']->table('shop_config') . " (code, value, parent_id, type) values('region_last_update', '" . time() . "', '3', 'text') ON DUPLICATE KEY UPDATE
code='region_last_update', value=".time();
