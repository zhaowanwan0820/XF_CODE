...
function SelectZone()
{
  ...
  this.addItem = function(all, act)
  {
    ...
    if (selOpt.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&add_ids=" +selOpt.JSON.stringify(), args, this.addRemoveItemResponse, "GET", "JSON");
    }
  }
  ...
  this.dropItem = function(all, act)
  {
    ...
    if (arr.length > 0)
    {
      ...
      Ajax.call(this.filename + "&act="+act+"&drop_ids=" + arr.JSON.stringify(), args, this.addRemoveItemResponse, 'GET', 'JSON');
    }
  }
