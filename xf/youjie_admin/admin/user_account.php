...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit')
{
    ...
    if ($_REQUEST['act'] == 'edit')
    {
        ...
        /* 取得hashid */
        $sql = "SELECT hashid FROM " .$ecs->table('users'). " WHERE hashid = '$user_account[hashid]'";
        $hashid = $db->getOne($sql);
    }
    else
    {
        $surplus_type = '';
...
function account_list()
{
    ...
    if ($result === false)
    {
        ...
        /* 查询数据 */
        $sql  = 'SELECT ua.*, u.user_name,u.hashid FROM ' .
