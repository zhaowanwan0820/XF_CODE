...
if (!defined('IN_ECS'))
{
    ...
    $purview['01_goods_list']        = 'goods_lists';
    $purview['02_goods_add']         = 'goods_manage';
    $purview['03_category_list']     = array('cat_manage', 'cat_drop');   //分类添加、分类转移和删除
    $purview['03_new_category_list'] = array('cat_manage', 'cat_drop');   //分类添加、分类转移和删除
    ...
    //分销管理
    $purview['01_mlm_activity_list']     = 'mlm_activity_list';
    $purview['02_mlm_goods_list']        = 'mlm_goods_list';
    $purview['03_mlm_dashboard']         = 'mlm_dashboard';
    ...
    $purview['11_account_change_audit'] = 'account_change_audit';
   ...
   // $purview['suppliers_list']          = 'suppliers_manage'; // 供货商
    ...
    $purview['11_import_invoice']    = 'import_invoice';
    $purview['12_comment_manage']    = 'comment_priv';
    $purview['13_debt_rollback']     = 'debt_rollback';
    $purview['14_order_finace']      = 'order_finace';
    $purview['15_goods_comment_set'] = 'goods_comment_set';
    ...
    // 商家管理
    $purview['suppliers_list']                  = 'suppliers_list';
    $purview['06_suppliers_shipping_tpl_list']  = 'suppliers_shipping_tpl_list';


    $purview['02_suppliers_account_list']  = 'suppliers_account_list';
    $purview['03_suppliers_account']       = 'suppliers_account';
    $purview['04_suppliers_shop_info']     = 'suppliers_shop_info';
    $purview['05_multi_statement_list'] = 'multi_statement_list';
    $purview['09_suppliers_surplus_transfer'] = 'suppliers_surplus_transfer';

    //商家电子面单管理
    $purview['06_printer_list']  = 'printer_list';
    $purview['07_client_code_list']   = 'client_code_list';
    $purview['08_business_address']   = 'business_address';
    //运营活动管理
    $purview['activity_list']        = 'activity_list';
    $purview['mlm_activity_list']       = 'mlm_activity_list';
    $purview['activity_coupon_list']  = 'activity_coupon_list';
    $purview['seckill_activity_list']  = 'seckill_activity_list';
    $purview['first_red_cash_back']     = 'first_red_cash_back';    // 首单红包返现

    //工单
    $purview['work_order_list']       = 'work_order_list';
    $purview['activity_coupon_list']  = 'activity_coupon_list';
    $purview['05_multi_statement_list'] = 'multi_statement_list';
    $purview['mlm_activity_list']       = 'mlm_activity_list';
    ...
    //首页商品
    $purview['goods_cat_plate']       = 'home_goods';

    // 网贷平台管理
    $purview['25_wd_platform']= 'wd_platform_list';
    // 网贷平台用户
    //$purview['26_user_wd_platform']= 'user_wd_platform_list';


    $purview['edit_password']= 'edit_password';
