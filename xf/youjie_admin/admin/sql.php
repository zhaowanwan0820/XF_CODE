...
if ($_REQUEST['act'] == 'query')
{
    $type = '0';
    admin_priv('sql_query');
    if (preg_match('/\b(update|insert|drop|create|alter|delete)\b/i', $_POST['sql'])) {
        admin_priv('db_modify');
        $type = '1';
    }
    addLog('action :query sql:'.$_POST['sql'],'info',$_SESSION['admin_name'],'sql_'.$type);
