...
$_LANG['ecshop']['goods_leavel1'] = '一级类目';
$_LANG['ecshop']['goods_leavel2'] = '二级类目';
$_LANG['ecshop']['goods_leavel3'] = '三级类目';
$_LANG['ecshop']['suppliers_id'] = '供应商编码';
$_LANG['ecshop']['suppliers_name'] = '供应商名称';
$_LANG['ecshop']['market_price'] = '市场售价';
$_LANG['ecshop']['shop_price'] = '本店售价';
$_LANG['ecshop']['cash'] = '现金';
$_LANG['ecshop']['money_line'] = '积分';
$_LANG['ecshop']['cash_ratio'] = '现金比例';
$_LANG['ecshop']['sales_number'] = '销售数量';
