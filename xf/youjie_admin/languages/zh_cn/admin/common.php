...
$_LANG['app_name'] = '有解商城';
$_LANG['app_slogan'] = '要购物 来有解商城';
$_LANG['app_service_tell'] = '010-89929966';
$_LANG['cp_home'] = '有解商城管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2018-'. date('Y') .' 有解商城';
...
$_LANG['19_suppliers_manage'] = '商家管理';
$_LANG['20_activity_manage'] = '运营活动管理';
$_LANG['21_work_order_manage'] = '工单管理';
$_LANG['23_promotion'] = '促销管理';
$_LANG['22_home_goods'] = '首页商品调整';
$_LANG['25_wd_platform'] = '网贷平台管理';
$_LANG['26_user_wd_platform'] = '网贷平台用户';
$_LANG['27_admin_profile'] = '个人中心';
/* 商品管理 */
$_LANG['01_goods_list'] = '商品列表';
$_LANG['02_goods_add'] = '添加新商品';
$_LANG['03_category_list'] = '商品分类';
$_LANG['03_new_category_list'] = '新商品分类';
...
/* 分销管理 */
$_LANG['01_mlm_activity_list']     = '分销活动列表';
$_LANG['02_mlm_goods_list']        = '分销商品列表';
$_LANG['03_mlm_dashboard']         = '分销数据看板';
...
$_LANG['11_import_invoice'] = '导入运单号';
$_LANG['12_comment_manage'] = '用户评论';
$_LANG['13_debt_rollback'] = '根据订单退债权';
$_LANG['14_order_finace'] = '财务';
$_LANG['15_goods_comment_set'] 	= '评论设置';
...
$_LANG['11_account_change_audit'] = '调节账户申请记录';
...
$_LANG['02_suppliers_account_list'] = '商家账户列表';
$_LANG['03_suppliers_account'] = '账户信息';
$_LANG['04_suppliers_shop_info'] = '店铺信息';
$_LANG['05_multi_statement_list'] = '汇总单列表';
$_LANG['06_printer_list'] = '打印机管理';
$_LANG['07_client_code_list'] = '客户号列表';
$_LANG['08_business_address'] = '商家地址信息';
$_LANG['09_suppliers_surplus_transfer'] = '积分转账';

$_LANG['06_suppliers_shipping_tpl_list']	= '运费模板列表';

/* 商家管理 */
$_LANG['activity_list'] = '活动管理';

/*运营活动管理*/
$_LANG['activity_manage']      = '活动管理';
$_LANG['activity_coupon_list'] = '优惠券管理';
$_LANG['seckill_activity_list'] = '秒杀活动管理';
$_LANG['first_red_cash_back'] 	= '下单有礼管理';

/*工单管理*/
$_LANG['work_order_list'] = '工单列表';

/*分销管理*/
$_LANG['mlm_manage']        = '分销管理';
$_LANG['mlm_activity_list'] = '活动列表';
$_LANG['mlm_goods_list']    = '商品列表';
$_LANG['mlm_dashboard']     = '数据看板';
$_LANG['goods_cat_plate']   = '商品专区列表';
...
/* 生成电子面单 */
$_LANG['expressName'] = '快递公司';
$_LANG['customArea'] = '商家自定义区域';
$_LANG['customArea'] = '商家自定义区域';
$_LANG['transType'] = '运输方式';
$_LANG['shipperCode'] = '快递公司编码';
$_LANG['payType'] = '邮费支付方式';
$_LANG['expressTypeId'] = '快递类型';
$_LANG['isReturnSignBill'] = '是否要求签回单';
$_LANG['operateRequire'] = '签回单操作要求';
$_LANG['isNotice'] = '是否通知快递员上门揽件';
$_LANG['startDate'] = '上门取货时间段';
$_LANG['endDate'] = '上门取货时间段';
$_LANG['isSendMessage'] = '是否订阅短信';
$_LANG['isReturnPrintTemplate'] = '返回电子面单模板';
$_LANG['templateSize'] = '模板规格';
$_LANG['packingType'] = '包装类型';
$_LANG['deliveryMethod'] = '送货方式';
$_LANG['suppliersEorderInfoId'] = '商家与电子面单客户号关联id';

/* 网贷平台管理 */
$_LANG['wd_platform'] = '网贷平台管理';
$_LANG['wd_add_deit'] = '添加编辑平台';
$_LANG['wd_use_person'] = '出借人';
$_LANG['wd_use_detail'] = '代付明细';

/* 网贷平台用户 */
$_LANG['user_wd_platform'] = '网贷平台用户';
$_LANG['01_user_wd_index'] = '首页';
$_LANG['02_user_wd_add_deit'] = '浣豆账户明细';
$_LANG['03_user_wd_use_detail'] = '代付明细';
$_LANG['04_user_wd_use_person'] = '出借人';

/* 个人中心 */
$_LANG['edit_password'] = '重置密码';
