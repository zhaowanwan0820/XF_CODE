...
$_LANG['use_help'] = '使用说明：' .
        '<ol>' .
          ...
          '<li>填写csv文件，可以使用excel或文本编辑器打开csv文件；<br />' .
              '碰到“是否推荐”之类，填写数字0或者1，0代表“否”，1代表“是”；<br />' .
...
$_LANG['upload_goods']['provider_name'] = '供应商';
...
$_LANG['upload_goods']['goods_location'] = '货位号';
$_LANG['upload_goods']['is_best'] = '是否推荐';
$_LANG['upload_goods']['is_new'] = '是否新品';
$_LANG['upload_goods']['is_hot'] = '是否热销';
$_LANG['upload_goods']['is_on_sale'] = '是否上架';
$_LANG['upload_goods']['is_sell_out'] = '是否自动下架';
$_LANG['upload_goods']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['upload_goods']['hh_newbie'] = '是否仅供新手商品';
