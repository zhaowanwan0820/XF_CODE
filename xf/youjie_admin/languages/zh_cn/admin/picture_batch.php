...
//新增根据商品id范围批量生成图片
$_LANG['between_info'] = '根据商品ID范围：';
$_LANG['between_min'] = '最小值：';
$_LANG['between_max'] = '最大值：';
$_LANG['number_info'] = '请输入正整数';
$_LANG['number_between'] = '商品ID最大跨度不超过1000';
$_LANG['alert_max'] = '请输入最大值';
$_LANG['alert_min'] = '请输入最小值';
$_LANG['error_number'] = '最大值不得小于等于最小值';
