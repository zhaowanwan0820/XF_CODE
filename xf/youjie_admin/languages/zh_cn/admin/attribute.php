...
$_LANG['drop_confirm'] = '您确实要删除该属性吗？';
$_LANG['notice_drop_confirm'] = '已经有%s个商品使用该属性，是否下载商品清单？';
$_LANG['name_not_null'] = '属性名称不能为空。';

$_LANG['no_select_arrt'] = '您没有选择需要删除的属性名';
$_LANG['drop_ok'] = '成功删除了 %d 条商品属性';
$_LANG['drop_message'] = '在使用中的商品属性不可移除';
$_LANG['attr_goods'] = '属性商品';
$_LANG['down_info'] = '(点击下载)';
$_LANG['execl_name'] = '属性商品清单.xls';
...
$_LANG['js_languages']['error_attr_name'] = '属性名称为字母、数字、中文。';
