...
$_LANG['op_return_offline'] = '线下退款';

$_LANG['refund_huan'] = '退还积分：';
$_LANG['refund_action'] = '退款说明：';
$_LANG['refund_huan_default'] = '请输入0―%s之间的数值';
$_LANG['refund_huan_after'] = '商品总金额%s元,运费%s元,订单总金额%s元';
$_LANG['refund_cash'] = '退还现金：';
$_LANG['refund_amount_after'] = '(商品积分支付金额%s元,现金支付金额%s元)';
$_LANG['refund_order_surplus'] = '积分支付：%s元';
$_LANG['refund_order_money_paid'] = '现金支付：%s元';

$_LANG['js_languages']['pls_input_huan'] = '请输入退还积分！';
$_LANG['js_languages']['pls_input_order_status'] = '【部分退还积分仅支持已发货的订单】';
$_LANG['js_languages']['pls_input_cash'] = '请输入退还现金！';

/* 订单列表 */
$_LANG['order_amount'] = '应付金额';
$_LANG['settlement_money_total'] 	= '结算价金额';
$_LANG['total_fee'] = '总金额';
...
/*新增 20190225*/
$_LANG['shop_price'] = '商店售价';
$_LANG['provider_name'] = '供货商名称';
$_LANG['province'] = '省份';
$_LANG['city'] = '城市';
$_LANG['district'] = '区域';
...
$_LANG['cancel_electronic_order'] = '取消电子面单';
$_LANG['query_logistics_info'] = '查询物流轨迹';
...
$_LANG['mlm_user'] = '换换客：';
$_LANG['mlm_price'] = '分销底价：';
$_LANG['mlm_shop_price'] = '运营底价：';
$_LANG['mlm_act_price'] = '活动底价：';
$_LANG['mlm_new_award'] = '拉新奖励';
$_LANG['mlm_act_award'] = '活动奖励';
$_LANG['mlm_pay_cash'] = '分销成交价：';
$_LANG['mlm_rebate'] = '分销佣金：';
$_LANG['mlm_unpay'] = '积分未变现：';
$_LANG['mlm_payed'] = '积分已变现：';
$_LANG['mlm_real_award'] = '实得拉新、活动奖励：';
...
$_LANG['from'] = '来自站点：';
$_LANG['from_mlm'] = '分销返佣';
$_LANG['from_instalment'] = '分期订单';
$_LANG['from_seckill'] = '秒杀订单';
$_LANG['from_train'] = '直通车订单';

/* 添加、编辑订单 */
$_LANG['order_type_share'] = '好友代付订单';
$_LANG['order_type_mlm']   = '换换客订单';
$_LANG['order_type_default'] = '普通订单';
...
$_LANG['refund'] = '退款';
$_LANG['cannot_edit_order_shipped'] = '您不能修改发货中/已发货的订单';
...
$_LANG['js_languages']['pls_select_shipping'] = '请填写配送方式';
...
$_LANG['js_languages']['pls_input_refund'] = '请您填写退款说明！';
...
$_LANG['js_languages']['pls_select_consignee'] = '请输入收货人';
$_LANG['js_languages']['pls_select_email'] = '请输入电子邮件';
$_LANG['js_languages']['pls_select_address'] = '请输入地址';
$_LANG['js_languages']['pls_select_mobile'] = '请输入手机';
$_LANG['js_languages']['invoice_vo_error'] = '发货单号格式不正确';
...
$_LANG['return_user_money'] = '退回用户余额(不可使用)';
$_LANG['create_user_account'] = '生成退款申请(不可使用)';
$_LANG['not_handle'] = '用户支付的余额、现金等等，将退回原支付方式中';
...
$_LANG['default_execl'] = '默认';
$_LANG['express_execl'] = '快递助手';
$_LANG['sure'] = '确定';
$_LANG['cancle'] = '取消';
$_LANG['label_shipping_info'] = '发货信息';
$_LANG['collecting_amount'] = '代收金额';
$_LANG['insurance_amount'] = '保价金额';
$_LANG['business'] = '业务类型';
$_LANG['dafault_template'] = '订单号运单号快递公司';
$_LANG['express_template'] = '创建时间订单编号收件人电话地址发货信息发件人发件人电话发件人地址备注代收金额保价金额业务类型快递名称快递单号';

$_LANG['export_settlement_money'] 	= '结算价';
$_LANG['export_money_paid'] = '现金支付';
$_LANG['export_surplus'] = '积分支付';
$_LANG['recipients'] = '收件人';
$_LANG['fixed_line'] = '固话';
$_LANG['mobiles'] = '手机';

$_LANG['mlm_order'] = '分销订单';
$_LANG['cannot_found_order'] = '找不到指定订单';
$_LANG['order_debt_rollback'] = '根据订单退债权';
$_LANG['return_debt_rollback'] = '退回%s元积分到原债权中，原订单编号为%s';
$_LANG['debt_rollback_note'] = '订单退回原债权：订单编号%s，金额：%s元 %s';

$_LANG['p_name'] = '支付方式：';
$_LANG['s_name'] = '配送方式：';
$_LANG['lab_goods_cat'] = '商品分类：';
$_LANG['set_to_email'] = '收件邮箱：';
$_LANG['email_info'] = '导出订单会在5-10分钟内以附件形式发送至该邮箱：';
$_LANG['file_name'] = '文件名称：';
$_LANG['export_name_info'] = '设置文件名称';

$_LANG['instalment_info'] = '分期信息';
$_LANG['instalment_column_instalment'] = '分期';
$_LANG['instalment_column_all'] = '总额/期';
$_LANG['instalment_column_money'] = '现金/期';
$_LANG['instalment_column_surplus'] = '积分/期';
$_LANG['instalment_column_time'] = '支付时间';
$_LANG['instalment_column_method'] = '支付方式';
$_LANG['instalment_column_sn'] = '子订单编号';
$_LANG['instalment_column_status'] = '子订单状态';
$_LANG['instalment_column_over'] = '逾期时间';
$_LANG['instalment_money'] = '总额：';
$_LANG['instalment_money'] = '现金：';
$_LANG['instalment_surplus'] = '积分：';
$_LANG['instalment_all'] = '总额：';
$_LANG['instalment_os'] = ['待支付', '已支付', '已退款', '已取消'];
$_LANG['instalment_method'] = [1 => '年付', 2 => '半年付', 3 => '季付', 4 => '月付', '全款'];

// 线下绑定
$_LANG['return_offline_huanbi'] = '积分数量：';
$_LANG['offline_huanbi_content'] = '积分线下退款申请';
$_LANG['offline_audit_id'] = '编号';
$_LANG['offline_audit_username'] = '会员名称';
$_LANG['offline_audit_huanbi'] = '积分变动额度';
$_LANG['offline_audit_time'] = '申请时间';
$_LANG['offline_audit_status'] = '审核状态';
$_LANG['offline_audit_desc'] = '备注';
$_LANG['offline_audit_status_list'] = [1 => '待审核', 2 => '审核通过', 3 => '审核未通过'];
