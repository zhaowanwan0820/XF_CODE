...
$_LANG['suppliers_mange'] = '商家管理';
$_LANG['activity_mange'] = '运营内容管理';
$_LANG['work_order_manage'] = '工单管理';
...
$_LANG['account_change_audit'] = '调节账户申请记录';
$_LANG['account_change_audit_edit'] = '审核调节账户申请';
...
//订单管理部分权限
$_LANG['order_os_edit'] = '编辑订单状态';  //合并订单
...
$_LANG['import_invoice'] = '导入运单号';
$_LANG['order_cancle'] = '取消订单';
$_LANG['debt_rollback'] = '根据订单退债权';
$_LANG['order_finace'] = '财务';
$_LANG['goods_comment_set']		= '评论设置';
...
$_LANG['suppliers_account_list'] = '商家账户列表';
$_LANG['suppliers_account'] = '账户信息';
$_LANG['suppliers_shop_info'] = '店铺信息';
$_LANG['suppliers_account_operator'] = '汇总单列表-运营';
$_LANG['suppliers_account_finance'] = '汇总单列表-财务';
$_LANG['printer_list'] = '打印机管理';
$_LANG['client_code_list'] = '客户号列表';
$_LANG['business_address'] = '商家地址信息';
$_LANG['multi_statement_list'] = '汇总单列表';
$_LANG['suppliers_shipping_tpl_list']	= '运费模板列表';
$_LANG['suppliers_surplus_transfer'] = '积分转账';


/*运营活动*/
$_LANG['activity_list'] = '活动管理';
$_LANG['activity_info'] = '查看活动';
$_LANG['activity_edit'] = '添加/编辑活动';

$_LANG['activity_coupon_list'] = '优惠券管理';
$_LANG['activity_coupon_info'] = '查看优惠券';
$_LANG['activity_coupon_edit'] = '添加/编辑优惠券';
...
$_LANG['home_goods'] = '首页商品调整';

$_LANG['wd_platform'] = '网贷平台管理';
// $_LANG['user_wd_platform'] = '网贷平台用户';
// $_LANG['user_wd_index'] = '首页';
// $_LANG['user_wd_add_deit'] = '浣豆账户明细';
// $_LANG['user_wd_use_detail'] = '代付明细';
// $_LANG['user_wd_use_person'] = '出借人';

$_LANG['admin_user_profile'] = '个人中心';
?>
