...
/*------------------------------------------------------ */
/****新增商品订单字段*****/
$_LANG['waiting_send'] = '待发货订单';
$_LANG['already_send'] = '已发货订单';
$_LANG['deals_success'] = '交易成功订单';
$_LANG['after_sale'] = '售后订单';
$_LANG['cancel'] = '取消订单';

$_LANG['goods_info'] = '商品统计信息';
$_LANG['already_on_sale'] = '已上架商品';
$_LANG['already_not_sale'] = '已下架的商品';
$_LANG['sold_out'] = '已售罄商品';

$_LANG['waite_audit'] = '待审核商品';
$_LANG['audit_success'] = '审核通过商品';
$_LANG['audit_fail'] = '审核失败商品';
/****新增商品订单字段*****/
