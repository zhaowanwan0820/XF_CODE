...
<div id="menu-div">
  <ul>
    ...
    <?php if ($this->_var['admin_type'] != 2): ?>
    <li><a href="index.php?act=main" target="main-frame"><?php echo $this->_var['lang']['admin_home']; ?></a></li>
    
    <!--商家展示信息的地方-->
    <?php if ($this->_var['admin_type'] != 0): ?>
    <li><a href="suppliers.php?act=show" target="main-frame"><?php echo $this->_var['lang']['shop_info']; ?></a></li>
    <li><a href="https://itzstatic.b0.upaiyun.com/ecshop/BusinessBackgroundHelp/index.html" target="main-frame">帮助中心</a></li>
    <?php endif; ?>
