...
.panel-hint{top: 3%;}
.login-body{background: url(images/ecshop_login_bg.png) no-repeat center center;}
...
<div class="form-header">
  <div class="logo"></div>
  <div class="tel">客服电话：400-010-1616</div>
</div>
...
<!-- <div class="copy-right">&copy; 2018-<?php echo $this->_var['now_year']; ?> HuanHuan,Inc.All rights reserved.</div> -->
<script language="JavaScript">
