...
<link href="styles/main.css?6" rel="stylesheet" type="text/css" />
...
<h1>
  ...
  <a class="btn btn-right action-span6" href="https://yunqi.shopex.cn/products/crm" target="_blank">开通会员高级管理</a>
  <?php endif; ?>
  ...
  <!--<a class="btn btn-right" href="https://yunqi.shopex.cn/products/huodiantong" target="_blank">快速录入商品</a>-->
  <?php elseif ($this->_var['action_link']): ?>
    <?php if ($this->_var['action_link']['other']): ?>
      <?php $_from = $this->_var['action_link']['other']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'other');if (count($_from)):
    foreach ($_from AS $this->_var['other']):
?>
        <a class="btn btn-right" href="<?php echo $this->_var['other']['href']; ?>"><?php echo $this->_var['other']['text']; ?></a>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php endif; ?>
